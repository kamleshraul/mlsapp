			      		 ...
			      		 <fo:table table-layout="fixed" width="100%" >
								...
								<fo:table-row>
									<fo:table-cell text-align="start">
										<fo:block>
											<xsl:value-of select="element_1_8"></xsl:value-of>
										</fo:block>										
									</fo:table-cell>
								...
								<fo:table-row>
									<fo:table-cell text-align="start">
										<fo:block>
											<xsl:value-of select="element_1_20"></xsl:value-of>
										</fo:block>										
									</fo:table-cell>
									<fo:table-cell text-align="center">
									<xsl:choose>
										<xsl:when test="element_1_26!=''">
											<fo:block>
												प्रथम <xsl:value-of select="element_1_26"></xsl:value-of>
											</fo:block>	
										</xsl:when>
										<xsl:otherwise>
											<fo:block></fo:block>	
									...
									<fo:table-cell text-align="end" >
										<fo:block>
											<xsl:value-of select="element_1_9"></xsl:value-of>
										</fo:block>										
									</fo:table-cell>
								</fo:table-row>
							</fo:table-header>
							<fo:table-body>	
											...
											<fo:block>
												<xsl:choose>
													...
													<fo:block text-align="center" font-weight="bold">
														(उपाध्यक्षस्थानी माननीय <xsl:apply-templates select="element_1_10"></xsl:apply-templates>&#160; <xsl:apply-templates select="element_1_4"></xsl:apply-templates>)
													</fo:block>
													<fo:block>&#160;</fo:block>
													</xsl:when>
												</xsl:choose>
								...
								<fo:table-row>
									<fo:table-cell display-align="center" text-align="right" number-columns-spanned="3" >
										<xsl:choose>
											<xsl:when test="element_1_25!=''">
												<fo:block>
												या नंतर <xsl:apply-templates select="element_1_25"></xsl:apply-templates>
												</fo:block>	
											</xsl:when>
											<xsl:otherwise>
												<fo:block></fo:block>
