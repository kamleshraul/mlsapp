...
<xsl:stylesheet version="1.1"
    ...
    <xsl:template match="root">
	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">	  
			...
			<!--        		<xsl:if test="element_4='motions_rules_suspension'">
						        ...
						        <fo:table-header>
						        	<fo:table-row>
						        		<fo:table-cell display-align="before" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<xsl:choose>
						        				<xsl:when test="element_4='motions_rules_suspension'">
							        		...
							        		<xsl:choose>
							        			<xsl:when test="position()!=last()">
									        		...
									        		<fo:table-cell margin-left="0.3cm" margin-right="0.3cm" display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
									        		 ...
									        		 <fo:table-cell text-align="justify" margin-left="0.8cm" margin-right="0.3cm" display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
									        			<fo:block>
