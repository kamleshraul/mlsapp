	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">	  
	        ...
	        <fo:page-sequence master-reference="first" id="DocumentBody">
	            ...
	            <fo:flow flow-name="xsl-region-body">		    
			       ...
			       <fo:block font-size="20px" text-align="center" font-weight="bold"><xsl:value-of select="element_3[1]"/></fo:block>
			       <fo:block font-size="20px" text-align="center" font-weight="bold"><xsl:value-of select="element_3[2]"/></fo:block>
			       <fo:block font-size="20px" text-align="center" font-weight="bold"><xsl:value-of select="element_3[3]"/></fo:block>
			       <fo:block font-size="40px" text-decoration="underline" padding-top="10cm" text-align="center" font-weight="bold"><xsl:value-of select="element_3[4]"/></fo:block>
           			 <!-- Add a page break -->
						        	...
						        	<fo:table-row>
						        		<fo:table-cell display-align="center" text-align="center" border-width="0.5pt" border-style="solid">
						        			<fo:block font-weight="bold">
						        			    <xsl:value-of select="element_3[5]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-width="0.5pt" border-style="solid">
						        			<fo:block font-weight="bold">
						        				<xsl:value-of select="element_3[6]"/>
						        			</fo:block>
						           		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-width="0.5pt" border-style="solid">
						        			<fo:block font-weight="bold">
						        		...
						        		<fo:table-cell display-align="center" text-align="center" border-width="0.5pt" border-style="solid">
						        			<fo:block font-weight="bold">
						        				<xsl:value-of select="element_3[8]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        	</fo:table-row>
						        </fo:table-header>
