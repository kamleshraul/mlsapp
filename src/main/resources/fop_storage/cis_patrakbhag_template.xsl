			      ...
			      <xsl:choose>
						<xsl:when test="./element_1/element_1_7='विधानसभा'">
								  <fo:block  font-size="14px">
			       					&#160;&#160;&#160;&#160;&#160;सन २०१५-२०१६ या वर्षासाठी विधानमंडळाच्या विविध समित्यावर मा.अध्यक्ष,महाराष्ट्र विधानसभा यांनी <xsl:value-of select="./element_2"/> रोजी विधानसभा सदस्यांची खालीलप्रमाणे नामनियुक्ती केली आहे.				       		
			      	  			 </fo:block>
						</xsl:when>
						<xsl:when test="./element_1/element_1_7='विधानपरिषद'">
							  		<fo:block  font-size="14px">
			       					&#160;&#160;&#160;&#160;&#160;सन २०१५-२०१६ या वर्षासाठी विधानमंडळाच्या विविध समित्यावर मा.उप सभापती,महाराष्ट्र विधानपरिषद यांनी <xsl:value-of select="./element_2"/> रोजी विधानपरिषद सदस्यांची खालीलप्रमाणे नामनियुक्ती केली आहे.				       		
			      	  				</fo:block>
						</xsl:when>
						<xsl:when test="./element_1/element_1_7='दोन्ही सभागृह'">
								 <fo:block  font-size="14px">
			       					&#160;&#160;&#160;&#160;&#160;सन २०१५-२०१६ या वर्षासाठी विधानमंडळाच्या विविध समित्यावर मा.अध्यक्ष,महाराष्ट्र विधानसभा व मा.उप सभापती,महाराष्ट्र विधानपरिषद यांनी <xsl:value-of select="./element_2"/> रोजी विधानसभा व विधानपरिषद सदस्यांची खालीलप्रमाणे नामनियुक्ती केली आहे.				       		
			      	  			 </fo:block>
						</xsl:when>
			</xsl:choose>
