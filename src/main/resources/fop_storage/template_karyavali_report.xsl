...
<xsl:stylesheet version="1.1"
    ...
    <xsl:variable name="language" select="ResolutionData/locale"/>
    <xsl:variable name="formatOut" select="ResolutionData/outputFormat"/>
      ...
      <fo:region-after extent="1.5cm"/>
			...
			<fo:block font-family="{$font}" font-size="12px" font-weight="normal" font-style="normal" space-after.optimum="3pt" text-align="justify">
				...
				<fo:list-item space-before="6pt">
				  <!-- insert a bullet -->
				  <fo:list-item-label end-indent="label-end()">
				    <fo:block><fo:inline>(<xsl:value-of select="formattedNumber" />)</fo:inline></fo:block>
				  </fo:list-item-label>
				  <!-- list text -->
				  <fo:list-item-body start-indent="body-start()">
				    <fo:block>
