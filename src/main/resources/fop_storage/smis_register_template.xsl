	            		...
	            		<xsl:choose>
	            			<xsl:when test="element_1">
	            				<fo:block text-align="center" font-size="20px" font-weight="bold">
			            			...
			            			<fo:inline text-align="center" font-size="12px">
					            		<xsl:choose>
                                     		<xsl:when test="element_1[1]/element_1_3='lowerhouse'">(म.वि. नियम १०१- अ)</xsl:when>
                                     		<xsl:when test="element_1[1]/element_1_3='upperhouse'">(म.वि.प. नियम १०१- अ)</xsl:when>
						                 </xsl:choose>
				                    </fo:inline>
			            		</fo:block>
											...
											<fo:table-cell column-number="2" border-left="0.5pt solid black" border-right="0.5pt solid black">
												<fo:block>
													<fo:table table-layout="fixed" width="100%">
								                        ...
								                        <fo:table-column column-number="2" column-width="5.9cm" />
								                        ...
								                        <fo:table-header>
								                        	<fo:table-row>
									                        	...
									                        	<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
									                        	    <fo:block text-align="center" font-weight="bold">
							                                    		मा.सदस्यांनी सभागृहात मांडलेल्या सुचानेचा दिनांक
								                                    </fo:block>
									                        	</fo:table-cell>
									                        	<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
									                        	 	<fo:block text-align="center" font-weight="bold">
							                                    		विभागाला पाठविल्याचा जावक क्रमांक व
								                                    </fo:block>
								                                    <fo:block text-align="center" font-weight="bold">
							                                    		दिनांक/विभाग
								                                    </fo:block>
