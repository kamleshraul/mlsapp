	            			...
	            			<xsl:when test="element_1">
			            		...
			            		<fo:block>
			            			...
			            			<fo:block page-break-before="always">
			            				&#160;&#160;&#160;&#160;&#160;वरील अतिशय गंभीर व तातडीच्या विषयाबाबत चर्चा करण्यासाठी सभागृहाचे सर्व कामकाज बाजूला ठेऊन/ प्रश्नोत्तराचा तास स्थगित करून म.वि.प. नियम २८९ च्या तरतुदी प्रमाणे स्थगित करून चर्चा करण्यात यावी असे सूचनेत नमूद केले आहे. 
			            			</fo:block>
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			<fo:block>
			            				&#160;&#160;&#160;&#160;&#160;उक्त सूचनेच्या संदर्भात नमूद करण्यात येते की, “महाराष्ट्र विधानपरिषद नियम २८९ नुसार कोणत्याही सदस्याला मा. उप सभापतींच्या संमतीने कोणताही नियम “सभागृहापुढील कोणत्याही विशिष्ट प्रस्तावास तो लागू करताना” स्थगित करण्यात यावा असा प्रस्ताव मांडता येईल आणि प्रस्ताव मंजूर झाला तर संबंधित नियम त्या वेळेपुरता स्थगित होईल.
			            			</fo:block>
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			<fo:block>
			            				&#160;&#160;&#160;&#160;&#160;नियम स्थगित करण्यासंदर्भात मे.कौल आणि शकधर यांच्या प्रॅक्टिस अँड प्रोसिजर ऑफ पार्लमेंट या पुस्तकातील (सातवी आवृत्ती) पृष्ठ क्रमांक १०५६ वरील मजकूर कृपया पाहावा, यावरून असे दिसून येते की, प्रश्नोत्ताराचा तास स्थगित करण्यासाठी दिवसाच्या कामकाजाच्या क्रमात एखादा विशिष्ट असा प्रस्ताव सभागृहासमोर असणे आवश्यक आहे व तो विचारात घेण्यासाठी प्रश्नोत्तराचा तास स्थगित करण्यासंबंधात प्रस्ताव देता येईल.
			            			</fo:block>
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			<fo:block>
			            				&#160;&#160;&#160;&#160;&#160;कौल आणि शकधर यांच्या सदर पुस्तकातील पृष्ठ क्रमांक १०५६ वर असेही नमूद करण्यात आले आहे की, नियम स्थगित करण्यासंबंधात प्राप्त झालेल्या सुचनांमधील हरकतीच्या मुद्यांवर निर्णय देताना लोकसभेच्या माननीय अध्यक्षानी असे मत व्यक्त केले की, 
			            			</fo:block>
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			...
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			<fo:block>
			            				&#160;&#160;&#160;&#160;&#160;या वरून असे दिसून येईल की, महाराष्ट्र विधानपरिषद नियम २८९ अन्वये प्राप्त सूचना क्रमांक ___ बाबत आजच्या दिवसाच्या कामकाज पत्रिकेवर कोणतीही बाब समाविष्ट नाही. प्रस्तुत प्रस्ताव अमान्य करण्यात यावा.
			            			</fo:block>
			            			<fo:block font-size="6px">&#160;</fo:block>
			            			<fo:block>
			            				&#160;&#160;&#160;&#160;&#160;मान्यतेसाठी सादर
