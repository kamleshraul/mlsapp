	            ...
	            <fo:flow flow-name="xsl-region-body">		    
			       <fo:block font-family="Kokila" font-size="15px">
			       		<fo:block font-size="18px" text-align="center" font-weight="bold">
			       			...
			       			<fo:block font-size="15px"><xsl:apply-templates select="element_3[2]"/></fo:block>
			       		</fo:block>
										...
										<fo:table-cell column-number="2">
											<fo:block>
												<fo:table table-layout="fixed" border-collapse="collapse">
											        ...
											        <fo:table-body>
											        	<fo:table-row>
											        		<fo:table-cell margin-left="0.3cm"><fo:block><xsl:value-of select="element_3[3]"/></fo:block></fo:table-cell>
											        		<fo:table-cell text-align="center" margin-left="0.3cm"><fo:block>---</fo:block></fo:table-cell>
											        		<xsl:choose>
											        			<xsl:when test="element_1[1]/element_1_8!=''">
											        				<fo:table-cell margin-left="0.5cm"><fo:block><xsl:value-of select="element_1[1]/element_1_8"/></fo:block></fo:table-cell>
											        			</xsl:when>
											        			<xsl:otherwise>
											        				<fo:table-cell margin-left="0.5cm"><fo:block>-</fo:block></fo:table-cell>
											        			</xsl:otherwise>
											        		</xsl:choose>											        		
											        	</fo:table-row>
											        	<fo:table-row>
											        		<fo:table-cell margin-left="0.3cm"><fo:block><xsl:value-of select="element_3[4]"/></fo:block></fo:table-cell>
											        		<fo:table-cell text-align="center" margin-left="0.3cm"><fo:block>---</fo:block></fo:table-cell>
											        		<xsl:choose>
											        			<xsl:when test="element_1[1]/element_1_9!=''">
											        				<fo:table-cell margin-left="0.5cm"><fo:block><xsl:value-of select="element_1[1]/element_1_9"/></fo:block></fo:table-cell>
											        			</xsl:when>
											        			<xsl:otherwise>
											        				<fo:table-cell margin-left="0.5cm"><fo:block>-</fo:block></fo:table-cell>
											        			</xsl:otherwise>
											        	...
											        	<fo:table-row>
											        		...
											        		<xsl:choose>
											        			<xsl:when test="element_1[1]/element_1_10!=''">
											        				<fo:table-cell margin-left="0.5cm"><fo:block><xsl:value-of select="element_1[1]/element_1_10"/></fo:block></fo:table-cell>
											        			</xsl:when>
											        			<xsl:otherwise>
											        				<fo:table-cell margin-left="0.5cm"><fo:block>-</fo:block></fo:table-cell>
											        			</xsl:otherwise>
											        	...
											        	<fo:table-row>
											        		...
											        		<xsl:choose>
											        			<xsl:when test="element_1[1]/element_1_11!=''">
											        				<fo:table-cell margin-left="0.5cm"><fo:block><xsl:value-of select="element_1[1]/element_1_11"/></fo:block></fo:table-cell>
											        			</xsl:when>
											        			<xsl:otherwise>
											        				<fo:table-cell margin-left="0.5cm"><fo:block>-</fo:block></fo:table-cell>
											        			</xsl:otherwise>
											        	...
											        	<fo:table-row>
											        		...
											        		<xsl:choose>
											        			<xsl:when test="element_1[1]/element_1_12!=''">
											        				<fo:table-cell margin-left="0.5cm"><fo:block><xsl:value-of select="element_1[1]/element_1_12"/></fo:block></fo:table-cell>
											        			</xsl:when>
											        			<xsl:otherwise>
											        				<fo:table-cell margin-left="0.5cm"><fo:block>-</fo:block></fo:table-cell>
											        			</xsl:otherwise>
