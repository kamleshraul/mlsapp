	            ...
	            <fo:flow flow-name="xsl-region-body">	
	            	...
	            	<fo:block font-family="Mangal" font-size="10.5px" break-after="page">	            					
							...
							<fo:block margin-left="1.5cm">								
								<xsl:choose>
									...
									<xsl:when test="primaryMemberDesignation='उप मुख्यमंत्री'">
										<fo:block>(१) माननीय <fo:inline font-weight="bold">मुख्यमंत्री </fo:inline></fo:block>
						...
						<fo:block text-align="right">
							...
							<fo:block margin-right="2cm">सचिव (का.)</fo:block>							
							<xsl:choose>
					...
					<fo:block font-family="Mangal" font-size="10.5px" break-after="page">	            					
						...
						<fo:block text-align="left">
							...
							<fo:block margin-left="0.40cm">सचिव (का.)</fo:block>
