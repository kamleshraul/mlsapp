	            ...
	            <fo:flow flow-name="xsl-region-body">	
	            	<fo:block font-family="Mangal" font-size="10.5px">	  
						...
						<fo:block text-align="left">
							...
							<fo:block margin-left="1.5cm">सचिव (का.),</fo:block>
						...
						<fo:block text-align="justify">							
								...
								<fo:table border="solid 0.2mm black" table-layout="fixed">
			                        ...
			                        <fo:table-header>
			                        	<fo:table-row>
			                        		...
			                        		<fo:table-cell border="solid 0.2mm black" display-align="before" text-align="center">
			                        			<fo:block-container font-weight="bold">
			                        				<fo:block>या सचिवालयाचे</fo:block>
			                        				<fo:block>पत्र क्रमांक</fo:block>
			                        			</fo:block-container>
			                        		</fo:table-cell>							                        		
			                        		<fo:table-cell border="solid 0.2mm black" display-align="before" text-align="center">
			                        			<fo:block-container font-weight="bold">
			                        				<fo:block>या सचिवालयास</fo:block>
							...
							<fo:block>
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;अत: महाराष्ट्र विधानपरिषद नियम क्रमांक ७० (२) च्या तरतुदींच्या अधीन राहता प्रश्नांची उत्तरे पाठविण्यास झालेल्या विलंबाची कारणे मा.सभापती, महाराष्ट्र विधानपरिषद यांना अवगत करण्यात यावीत व प्रस्तुत
								<xsl:choose>
									<xsl:when test="element_1[1]/element_1_2='questions_starred'">तारांकित</xsl:when>
									<xsl:when test="element_1[1]/element_1_2='questions_unstarred'">अतारांकित</xsl:when>
								</xsl:choose>
