	            ...
	            <fo:flow flow-name="xsl-region-body">		    
			       <fo:block font-family="Kokila" font-size="15px">
				      	...
				      	<fo:block>
						        ...
						        <fo:table-header>
						        	<fo:table-row>
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        		...
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block font-weight="bold"><xsl:apply-templates select="element_3[6]"/></fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block font-weight="bold"><xsl:apply-templates select="element_3[7]"/></fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block font-weight="bold"><xsl:apply-templates select="element_3[8]"/></fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block font-weight="bold"><xsl:apply-templates select="element_3[9]"/></fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="center" text-align="center" border-top-width="0.5pt" border-top-style="solid" border-bottom-width="0.5pt" border-bottom-style="solid">
							        		...
							        		<xsl:choose>
							        			<xsl:when test="position()!=last()">
									        		...
									        		<fo:table-cell text-align="center" margin-left="0.8cm" margin-right="0.3cm" display-align="center" padding-top="0.1cm" padding-bottom="0.1cm">
									        			...
									        			<fo:block font-size="17px">
									        				<xsl:value-of select="element_1_9"/>
									        			</fo:block>
									        		</fo:table-cell>
									        		<fo:table-cell text-align="center" margin-left="0.3cm" margin-right="0.3cm" display-align="center" padding-top="0.1cm" padding-bottom="0.1cm">
									        			<fo:block font-size="17px" margin-bottom="2mm">
									        				<xsl:value-of select="element_1_12"/>
									        			</fo:block>							        			
									        		</fo:table-cell>
									        		<fo:table-cell text-align="justify" margin-left="0.3cm" margin-right="0.3cm" display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
									        			<fo:block font-size="17px" margin-bottom="2mm">
