	            	...
	            	<fo:block font-family="Kokila" font-size="15px">	   
									...
									<fo:table-cell column-number="2">
										<fo:block>
											<fo:table table-layout="fixed" width="100%">
						            			...
						            			<fo:table-column column-number="2" column-width="0.4cm" />
												...
												<fo:table-body>
													<fo:table-row>
														...
														<fo:table-cell>
															<fo:block>
																मा.<xsl:value-of select="primaryMemberName"/>,
																<xsl:choose>
																...
																</fo:inline> या विषयावरील <xsl:value-of select="deviceType"/> क्रमांक <fo:inline font-weight="bold"><xsl:value-of select="number"/></fo:inline>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<fo:table-row>
														<fo:table-cell>
															<fo:block font-weight="bold">
																<fo:block font-weight="bold">संदर्भ</fo:block>																
															</fo:block>										
														</fo:table-cell>
														<fo:table-cell>
															<fo:block>:</fo:block>
														...
														<fo:table-cell>
															<fo:block>
																या सचिवालयाचे पत्र क्र. ____/ ब-१/२, दिनांक __________
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
												</fo:table-body>
						...
						<fo:block>							
							...
							<xsl:choose>
								<xsl:when test="houseType='lowerhouse'">वि.स.स.</xsl:when>
								<xsl:when test="houseType='upperhouse'">वि.प.स.</xsl:when>
							</xsl:choose> यांचा उक्त विषयांकित वरील तारांकित स्वीकृत प्रश्न प्रथम <xsl:value-of select="answeringDate"/> रोजी उत्तरासाठी ठेवण्यात आला होता. 
							महाराष्ट्र विधानमंडळ कामकाज कार्यपद्धतीनुसार मा.सदस्यांचा सदर प्रश्न आता 
							<fo:inline font-weight="bold"><xsl:value-of select="answeringDate"/> रोजी ऐवजी
							<xsl:value-of select="nextAnsweringDate"/> रोजी</fo:inline> उत्तरासाठी ठेवण्यात आला असून प्रश्नोत्तराच्या तीन प्रती दिनांक __________ पर्यंत या सचिवालयाला पाठविण्यात याव्यात. 
							कृपया उत्तराच्या बदललेल्या दिनांकाची नोंद घेण्यात यावी.				
						</fo:block>						
						...
						<fo:block>		
							...
							<fo:block margin-left="1cm">	
							 ...
							 <fo:block margin-left="1cm">
							 	(२) मा.<xsl:value-of select="primaryMemberName"/>,
							 	<xsl:choose>
									<xsl:when test="houseType='lowerhouse'">वि.स.स.</xsl:when>
									<xsl:when test="houseType='upperhouse'">वि.प.स.</xsl:when>
								</xsl:choose>
