			     		...
			     		<xsl:for-each select="./element_1">
			     			...
			     			<fo:block>
			     				<fo:table table-layout="fixed" width="100%">
			                        ...
			                        <fo:table-body>
			                        	<xsl:for-each select="element_1_2/element_1_2_1">
			                        	<fo:table-row page-break-inside="avoid">
			                        		<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	   	<fo:block margin-left="0.2cm">
		                                        	<xsl:value-of select="element_1_2_1_1"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center">
		                                        	<xsl:value-of select="element_1_2_1_2"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block margin-left="0.2cm" margin-right="0.2cm">
		                                        	<xsl:value-of select="element_1_2_1_5"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block margin-left="0.2cm">
		                                            <xsl:value-of select="element_1_2_1_4"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center">
		                                        	<xsl:value-of select="element_1_2_1_6"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center">
		                                            <xsl:value-of select="element_1_2_1_7"></xsl:value-of>
			                                    </fo:block>
				                        	</fo:table-cell>
			                        	</fo:table-row>
			                        	</xsl:for-each>
