	            		...
	            		<xsl:choose>
	            			<xsl:when test="element_1">
			            		...
			            		<fo:block text-align="center" font-size="16px" font-weight="bold">
			            			<xsl:value-of select="element_1[1]/element_1_4"/> - भाग १
			            		</fo:block>
			            		<fo:block text-align="center" font-size="16px" font-weight="bold">
			            		...
			            		<fo:block>
			            			<fo:table table-layout="fixed" width="100%">
										...
										<fo:table-column column-width="20.5cm"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body>
											<fo:table-row>
			            		...
			            		<fo:block font-size="27px" font-weight="bold" text-decoration="underline" text-align="center">
			            			उर्वरित स्थगन प्रस्ताव मी दालनात नाकारलेले आहेत.
			            		</fo:block>        				
	            			</xsl:when>
	            			<xsl:otherwise>
	            				<fo:block text-align="center" font-size="16px" font-weight="bold">
	            	...
	            	<fo:block font-family="Kokila" font-size="15px">
	            		<xsl:choose>
	            			<xsl:when test="element_2">
	            				<fo:block text-align="center" font-size="18px" font-weight="bold">
			            			<xsl:value-of select="element_2[1]/element_2_1"></xsl:value-of>
			            		</fo:block>
			            		<fo:block text-align="center" font-size="16px" font-weight="bold">
			            			<xsl:value-of select="element_2[1]/element_2_4"/> - भाग २
			            		</fo:block>
			            		<fo:block text-align="center" font-size="16px" font-weight="bold">
			            			दिनांक : <xsl:value-of select="element_2[1]/element_2_2"></xsl:value-of>
			            		</fo:block>	
			            		<fo:block font-size="14px">&#160;</fo:block>
									                        ...
									                        <fo:table-body>
									                        	<xsl:for-each select="element_2">
										                        	<fo:table-row border="solid 0.1mm black">	                                	
									                                    <fo:table-cell display-align="before" border-width="0.5pt" border-style="solid" padding-left="5" padding-right="5">
									                                        <fo:block text-align="center">
									                                        	<xsl:value-of select="element_2_6" />
									                                        </fo:block> 
									                                    </fo:table-cell>		                                    
									                                    <fo:table-cell display-align="before" border-width="0.5pt" border-style="solid" padding-left="5" padding-right="5">
									                                        <fo:block text-align="left">
									                                        	<xsl:value-of select="element_2_8" />,
									                                        	<xsl:choose>
									                                        		<xsl:when test="element_2_3='lowerhouse'">वि.स.स.</xsl:when>
									                                        		<xsl:when test="element_2_3='upperhouse'">वि.प.स.</xsl:when>
									                                        	</xsl:choose>
									                                        </fo:block> 
									                                    </fo:table-cell>		                                    
									                                    <fo:table-cell display-align="before" border-width="0.5pt" border-style="solid" padding-left="5" padding-right="5">
									                                    ...
									                                    <fo:table-cell display-align="before" border-width="0.5pt" border-style="solid" padding-left="5" padding-right="5">
									                                        <fo:block text-align="justify" font-weight="bold">
									                                        	<xsl:value-of select="element_2_10" />
									                                        </fo:block>
									                                    </fo:table-cell>                                   	
									                                </fo:table-row>
								                                </xsl:for-each>
