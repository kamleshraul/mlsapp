			       ...
			       <fo:block font-family="Kokila" font-size="15px">
			       		<fo:block font-size="18px" text-align="center" font-weight="bold">
			       		 ...
			       		 <fo:block>
						        ...
						        <fo:table-header>
						        	<fo:table-row>
						        		<fo:table-cell display-align="before" font-weight="bold" border-top-width="0.5pt" border-top-style="solid">
						        		...
						        		<fo:table-cell number-columns-spanned="2" display-align="before" font-weight="bold" border-top-width="0.5pt" border-top-style="solid">
						        			<fo:block text-align="center" font-weight="bold">
						        	...
						        	<fo:table-row>
						        		<fo:table-cell number-columns-spanned="3" display-align="before" font-weight="bold" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="center" font-weight="bold">
						        				&#160;
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" font-weight="bold" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="center" font-weight="bold">
						        ...
						        <fo:table-body>
						        	<fo:table-row>				        	
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="right" margin-right="0.5cm">
						        				<xsl:value-of select="element_3[15]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="left" margin-left="0.5cm">
						        				<xsl:value-of select="element_3[16]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
					        		...
					        		<fo:table-row>				        	
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="right" margin-right="0.5cm">
						        				<xsl:value-of select="element_3[17]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="left" margin-left="0.5cm">
						        				<xsl:value-of select="element_3[18]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="center">
					        		...
					        		<fo:table-row>				        	
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="right" margin-right="0.5cm">
						        				<xsl:value-of select="element_3[19]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="left" margin-left="0.5cm">
						        				<xsl:value-of select="element_3[20]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="center">
					        		...
					        		<fo:table-row>				        	
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="right" margin-right="0.5cm">
						        				<xsl:value-of select="element_3[21]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="left" margin-left="0.5cm">
						        				<xsl:value-of select="element_3[22]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_16!=''">											
						        		...
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_17!=''">											
														<xsl:value-of select="element_1/element_1_17"/>
													</xsl:when>
													<xsl:otherwise>
														-
													</xsl:otherwise>
						        		...
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_18!=''">											
					        		...
					        		<fo:table-row>				        	
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="right" margin-right="0.5cm">
						        				<xsl:value-of select="element_3[23]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="left" margin-left="0.5cm">
						        				<xsl:value-of select="element_3[24]"/>
						        			</fo:block>
						        		</fo:table-cell>
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_13!=''">											
														<xsl:value-of select="element_1/element_1_13"/>
													</xsl:when>
													<xsl:otherwise>
														-
													</xsl:otherwise>
						        		...
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_14!=''">											
						        		...
						        		<fo:table-cell display-align="before" padding-top="0.1cm" padding-bottom="0.1cm" border-bottom-width="0.5pt" border-bottom-style="solid">
						        			<fo:block text-align="center">
						        				<xsl:choose>
													<xsl:when test="element_1/element_1_15!=''">											
