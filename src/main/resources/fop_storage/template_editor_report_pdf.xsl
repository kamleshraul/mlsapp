			...
			<fo:block font-size="10pt" text-align="start" font-family="{$font}" font-style="italic" font-weight="bold">
	            ...
	            <fo:flow flow-name="xsl-region-body"> 	    
					<fo:block font-family="{$font}" font-size="12px" font-weight="normal" font-style="normal" space-after.optimum="3pt" text-align="justify">
						<fo:table width="490px" table-layout="fixed">
							<fo:table-body>
								<xsl:choose>
												...
												<fo:table-cell>
													<fo:block font-weight="bold" font-size="12px" text-align="justify">
															 ...
															 <xsl:choose>
															 	<xsl:when test="string-length(./element_1_2)>0 and string-length(./element_1_3)>0">
															 		<fo:block text-align="center">
															 			पु. शी. <xsl:value-of select="./element_1_2"></xsl:value-of>
															 		</fo:block>
															 		<fo:block text-align="center">
															 			मु. शी. <xsl:value-of select="./element_1_3"></xsl:value-of>
															 		</fo:block>															 		
															 	</xsl:when>
															 	<xsl:when test="string-length(./element_1_2)>0 or string-length(./element_1_3)>0">
															 		<fo:block text-align="center">
															 			पु. शी. 
															 			/ मु. शी. <xsl:value-of select="./element_1_2"></xsl:value-of> <xsl:value-of select="./element_1_3"></xsl:value-of>
															 		</fo:block>															 		
															 	</xsl:when>
															 </xsl:choose>
														</xsl:if> -->
														...
														<fo:inline font-weight="normal">
															<xsl:choose>
																<xsl:when test="/*/element_2='edit' or /*/element_2='edited'">
																	<xsl:choose>
																		<xsl:when test="./element_1_22=''">
																			<xsl:value-of select="./element_1_1"></xsl:value-of>
																		</xsl:when>
																		<xsl:otherwise>
																			<xsl:value-of select="./element_1_22"></xsl:value-of>
																		</xsl:otherwise>
																	</xsl:choose>
																</xsl:when>
																<xsl:when test="/*/element_2='compile'">
																	compile
																	<xsl:value-of select="./element_1_1"></xsl:value-of>
																</xsl:when>															
															</xsl:choose>
