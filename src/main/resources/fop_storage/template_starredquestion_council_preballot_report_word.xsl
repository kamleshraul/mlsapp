...
<xsl:stylesheet version="1.1"
    ...
    <xsl:template match="root">
	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
		    ...
		    <!-- <fo:static-content flow-name="ra-left">
			  <fo:block font-family="Kokila" font-size="10pt" text-align="right">
			  	अवर सचिव,&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<fo:block/>
			  	महाराष्ट्र विधानमंडळ सचिवालय
			  </fo:block>
		    </fo:static-content> -->
			...
			<fo:block font-family="Kokila" font-size="15px" font-weight="normal" font-style="normal" space-after.optimum="3pt" text-align="justify">	       		
	                    <fo:table border-collapse="collapse" table-layout="fixed" width="100%">
	                        ...
	                        <fo:table-column column-number="2" column-width="12.4cm" />	                        	                        
							<fo:table-header>
							   <fo:table-row>
							   	  <fo:table-cell  number-columns-spanned="2">							   	  		
							   			<fo:block text-align='center' font-family="Kokila" font-weight="bold">
							   				<fo:block font-size="16pt">
							   	  				महाराष्ट्र विधानमंडळ सचिवालय
							   	  			</fo:block>
							   	  			<fo:block/><fo:block/>
							   	  			<fo:block font-size="14pt">
							   	  				विधानपरिषद प्रश्न पूर्व-बॅलेट
							   	  			</fo:block>									    
										   <fo:block/><fo:block/>
										   <fo:block font-weight="normal">
										   	...
										   	फेरीची पूर्व-बॅलेट सूची
										   </fo:block>
										</fo:block>
										
										<fo:block>&#160;</fo:block>
										
										<fo:block text-align='right' font-family="Kokila">
							   ...
							   <fo:table-row border="solid 0.1mm black" height="25pt">
				                        	...
				                        	<fo:table-cell padding-left="5" border-width="0.5pt" border-style="solid" display-align="center" text-align="center">
				                        	    	...
				                        	    	<xsl:choose>
				                        	    		...
				                        	    		<xsl:otherwise>
				                        	    			<fo:block font-weight="bold">
					                                                                    अनुपस्थित असलेल्या मा. सदस्यांचे नाव
						                                    </fo:block>				                        	    			
				                        	    		</xsl:otherwise>
				                        	    	</xsl:choose>		                                                                    
	                            ...
	                            <xsl:for-each select="./element_5" >
	                                <fo:table-row border="solid 0.1mm black" height="25pt">
	                                    ...
	                                    <fo:table-cell padding-left="5" display-align="center" text-align="center" border-width="0.5pt" border-style="solid">
	                                        <fo:block>
	                                        	<xsl:value-of select="element_5_1" />
	                                        </fo:block>
	                                    </fo:table-cell>
  ...
  <xsl:template name="space-for-each-character">                
       <xsl:param name="data"/>
       &#160;
  </xsl:template>    
</xsl:stylesheet>