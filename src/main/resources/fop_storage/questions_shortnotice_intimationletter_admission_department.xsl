	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">	  
	        ...
	        <fo:page-sequence master-reference="first" id="DocumentBody">	        	
	            ...
	            <fo:flow flow-name="xsl-region-body">	
	            	...
	            	<fo:block font-family="Mangal" font-size="10.5px" break-after="page">	            					
						...
						<fo:block text-align="left">
							...
							<fo:block margin-left="0.90cm">सचिव (कार्यभार)</fo:block>
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<fo:block margin-left="0.90cm"><xsl:value-of select="department"/>, (<xsl:value-of select="subDepartment"/>)</fo:block>
								</xsl:otherwise>
							</xsl:choose>								
							<fo:block margin-left="0.90cm">महाराष्ट्र शासन,</fo:block>
							<fo:block margin-left="0.90cm">मंत्रालय, मुंबई - ४०० ०३२</fo:block>	
						...
						<fo:block margin-left="1.3cm">
							...
							,दिनांकित __________________.
						</fo:block>
						<fo:block font-size="4px">&#160;</fo:block>	
						<fo:block>महोदय,</fo:block>	
						<fo:block margin-left="1.5cm">							
							&#160;&#160;&#160;&#160;&#160; सदर प्रश्न आता उत्तरासाठी <xsl:value-of select="answeringDate"/> रोजी ठेवण्यात आला असून
							अल्प सूचना प्रश्नोत्तराच्या ४५० प्रती दिनांक ______________ रोजी या सचिवालयास पाठविण्यात याव्यात अशी विनंती आहे. 
						</fo:block>	
						<fo:block font-size="4px">&#160;</fo:block>				
						<!-- <fo:block font-size="4px">&#160;</fo:block> -->				
						<fo:block text-align="right">
						...
						<fo:block>
							<fo:block font-weight="bold">प्रत माहितीसाठी :- </fo:block>
							<fo:block margin-left="1.0cm">	
								...
								<fo:block>
									२. <xsl:value-of select="primaryMember"/>
								</fo:block>
							</fo:block>
						</fo:block>	
