											...
											<fo:table table-layout="fixed" width="100%">
												...
												<fo:table-body>
													<fo:table-row border="solid 0.1mm black">
														...
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
													...
													<fo:table-row border="solid 0.1mm black">
														...
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block margin-left="0.3cm" margin-right="0.3cm">सम्मिलित तारांकित प्रश्न</fo:block>
														</fo:table-cell>
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
											...
											<fo:table table-layout="fixed" width="100%">
												...
												<fo:table-body>
													...
													<fo:table-row border="solid 0.1mm black">
														...
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block margin-left="0.3cm" margin-right="0.3cm">अतारांकित स्वीकृत झालेल्या अल्पसूचना</fo:block>
														</fo:table-cell>
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
																	<xsl:when test="element_1[2]/element_1_11=''">--</xsl:when>
																	<xsl:otherwise><xsl:value-of select="element_1[2]/element_1_11"/></xsl:otherwise>
																</xsl:choose>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
													...
													<fo:table-row border="solid 0.1mm black">
														...
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block margin-left="0.3cm" margin-right="0.3cm">सम्मिलित अल्पसूचना प्रश्न</fo:block>
														</fo:table-cell>
														<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
															<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
							       			...
							       			<fo:table table-layout="fixed" width="100%">
						                        ...
						                        <fo:table-body>
						                        	...
						                        	<fo:table-row border="solid 0.1mm black">
						                        		...
						                        		<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
						                        			<fo:block margin-left="0.3cm" margin-right="0.3cm">सम्मिलित प्रश्न</fo:block>
						                        		</fo:table-cell>
						                        		<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
						                        			<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
						                        	...
						                        	<fo:table-row border="solid 0.1mm black">
						                        		...
						                        		<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
						                        			<fo:block margin-left="0.3cm" margin-right="0.3cm">उत्तरीत झालेल्या प्रश्नांची संख्या (अता. यादी क्र.___ ते ___) (मागील सत्रातील स्वीकृत प्रश्नासह)</fo:block>
						                        		</fo:table-cell>
						                        		<fo:table-cell display-align="before" border-width="0.5pt" border-style="solid">
						                        			<fo:block text-align="center" margin-right="0.4cm" font-weight="bold">
																<xsl:choose>
