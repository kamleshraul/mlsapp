	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	        ...
	        <fo:page-sequence master-reference="otherPages" id="DocumentBody">
	            ...
	            <fo:flow flow-name="xsl-region-body">
	            	<fo:block font-size="20pt" font-weight="bold" text-decoration="underline" text-align="right">
	            		अतारांकित प्रश्नोत्तरांची  
	            		<xsl:choose>
							<xsl:when test="element_9 = '१'">
								पहिली
							</xsl:when>
							<xsl:when test="element_9 = '२'">
								दुसरी
							</xsl:when>
							<xsl:when test="element_9 = '३'">
								तिसरी
							</xsl:when>
							<xsl:when test="element_9 = '४'">
								चौथी
							</xsl:when>
							<xsl:when test="element_9 = '५'">
								पाचवी
							</xsl:when>
							<xsl:when test="element_9 = '६'">
								सहावी
							</xsl:when>
							<xsl:when test="element_9 = '७'">
								सातवी
							</xsl:when>
						</xsl:choose>
	            		यादी
	            	</fo:block>
	            	<fo:block font-family="Kokila" font-size="18pt" font-weight="normal" font-style="normal" space-after.optimum="3pt" text-align="justify">
					    <xsl:choose>
					    	...
					    	<xsl:when test="element_3='विधानपरिषद'">
					    		...
					    		<fo:block font-size="9px">&#160;</fo:block>
					    		<!-- <fo:block font-size="9px">&#160;</fo:block> -->
					    		<fo:block font-size="23" font-weight="bold" text-align="center">
									महाराष्ट्र <xsl:value-of select="element_3"/>												
								</fo:block>
								<fo:block font-size="2px">&#160;</fo:block>
	                	...
	                	<xsl:for-each select="./element_1" >
	                		...
	                		<fo:block text-align="center" font-size="11pt" space-before.optimum="3pt" space-after.optimum="8pt">                			
								___________
							</fo:block>
