	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	        ...
	        <fo:page-sequence master-reference="otherPages" id="DocumentBody">
	            ...
	            <fo:flow flow-name="xsl-region-body">
	            	<fo:block font-size="12pt" font-weight="bold" text-decoration="underline" text-align="right">
	            	...
	            	<fo:block font-family="Mangal" font-size="11pt" font-weight="normal" font-style="normal" space-after.optimum="3pt" text-align="justify">
					    <xsl:choose>
					    	...
					    	<xsl:when test="element_3='विधानपरिषद'">
			                	...
			                	<fo:block font-size="4.5px">&#160;</fo:block>             		                	           	
			                	<fo:block text-align="center" font-size="7pt" font-weight="bold">
			                		<fo:block font-size="11pt">प्रश्नांची एकूण संख्या - <xsl:value-of select="element_2"/></fo:block>
			                	</fo:block>
