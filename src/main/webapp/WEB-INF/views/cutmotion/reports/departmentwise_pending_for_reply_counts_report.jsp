...
<body>
	...
	<div id="reportDiv">
		<c:choose>
			...
			<c:when test="${report != null and not (empty report)}">
				...
				<div style="width: 750px;">
					<table class="strippedTable" border="1" style="width: 750px;">
						<thead>
							<tr>
								<th style="text-align: center; font-size: 13px; width: 240px; vertical-align: top;">${topHeader[1]}</th>
								<th style="text-align: center; font-size: 13px; width: 240px; vertical-align: top;">${topHeader[2]}</th>								
								<th style="text-align: center; font-size: 13px; width: 150px; vertical-align: top;">${topHeader[3]}</th>
										...
										<c:choose>
											<c:when test="${counter.count > 1}">
												<tr class="page-break-after-forced">
													<td style="text-align: left; font-size: 12px; width: 240px; vertical-align: top;">${r[1]}</td>
													<td style="text-align: left; font-size: 12px; width: 240px; vertical-align: top;">${r[2]}</td>													
													<td style="text-align: left; font-size: 12px; width: 150px; vertical-align: top;">${r[3]}</td>
			...
			<c:otherwise>
				<spring:message code="cutmotion.departmentwise_pending_for_reply_counts_report.nodatafound" text="No Cut-Motion Pending for Reply as of Now."/>
			</c:otherwise>
		</c:choose>
	</div>
</body>
