...
<head>
	<title>
	<spring:message code="cutmotion.member_cutmotions_view" text="Member's Cut Motions View"/>
	</title>
...
<body>
	...
	<div id="reportDiv">
		<c:choose>
					...
					<table class="strippedTable" border="1" style="width: 750px;">
						<thead>
							<tr>								
								...
								<th style="text-align: center; font-size: 12px; width: 210px; vertical-align: top;">${topHeader[2]}</th>		
								...
								<th style="text-align: center; font-size: 12px; width: 210px; vertical-align: top;">${topHeader[4]}</th>
							</tr>
										...
										<c:choose>
											<c:when test="${counter.count > 1}">
												<tr class="page-break-after-forced">
													<td style="text-align: left; font-size: 12px; width: 30px; vertical-align: top;">${r[1]}</td>
													<td style="text-align: justify; font-size: 12px; width: 210px; vertical-align: top;">${r[2]}</td>
													<%-- <td style="text-align: left; font-size: 12px; width: 60px; vertical-align: top;">${r[3]}</td> --%>																						
													<%-- <td style="text-align: left; font-size: 12px; width: 90px; vertical-align: top;">${r[5]}</td> --%>
													<td style="text-align: left; font-size: 12px; width: 210px; vertical-align: top;">${r[4]}</td>
												</tr>
											</c:when>
											<c:otherwise>
												<tr>
			...
			<c:otherwise>
				<spring:message code="member_cutmotions_view.nodatafound" text="No Data Found"/>
			</c:otherwise>
		</c:choose>
	</div>
</body>
