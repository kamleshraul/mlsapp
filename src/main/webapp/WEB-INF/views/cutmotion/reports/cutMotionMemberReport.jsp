				...
				<br>
				 <div style="width: 750px;">
					...
					<table style="width: 700px; border: 1px solid black;" border="1" align="center" class="strippedTable">  
						<thead>
							<tr>
								...
								<th style="width: 380px;">${topHeader[2]}</th>
						...
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
								...
								<tr class="page-break">
									...
									<td style="width: 20px; text-align: center;">${r[6]}</td>
									<td style="width: 380px; text-align: center;"> 
									<b><spring:message code="cutmotion.mainTitle" text="cutmotion mainTitle"/> : </b>${r[10]} 
									<br> 
									<b><spring:message code="cutmotion.subTitle" text="Cutmotion subTitle"/> :</b> ${r[11]}
									 </td>
									<td style="width: 120px; text-align: center;">${r[12]} </td>
									<td style="width: 50px; text-align: center;"> </td>
									<td style="width: 60px; text-align: center;">${r[5]}</td>
					...
					<%-- <div style="font-weight: bold;  width: 715px;  margin: 10px">
						...
						${labels[7]} - ${report[0][15]}&nbsp;&nbsp;${labels[8]} - ${report[0][16]}
					</div> --%>
				</div>
			</div>
		</c:otherwise>
