...
<body>
	...
	<div class="fields clearfix watermark">
		...
		<form:form action="cutmotion" method="POST" modelAttribute="domain">
			...
			<div id="reportDiv">
				...
				<p style="display:none;">
					<label class="small"><spring:message code="cutmotion.deviceType" text="Type"/>*</label>
			 ...
			 <div class="fields">
				...
				<p class="tright">
					...
					<security:authorize access="hasAnyRole('MEMBER_LOWERHOUSE','MEMBER_UPPERHOUSE')">		
						...
						<input id="sendforapproval" type="button" value="<spring:message code='cutmotion.sendforapproval' text='Send For Approval'/>" class="butDef">
						<input id="submitCutMotion" type="button" value="<spring:message code='cutmotion.submitmotion' text='Submit Motion'/>" class="butDef">
		...
		<input id="submissionMsg" value="<spring:message code='client.prompt.cutmotion.submit' text='Do you want to submit the motion.'></spring:message>" type="hidden">
