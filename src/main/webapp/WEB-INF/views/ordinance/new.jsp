...
<html>
	<head>
		<title>
			<spring:message code="ordinance" text="Ordinance"/>
		</title>
	...
	<body>	
		<div class="fields clearfix vidhanmandalImg">
			<form:form action="ordinance" method="POST"  modelAttribute="domain">
				...
				<p> 
					<label class="small"><spring:message code="ordinance.year" text="Year"/></label>
				...
				<p> 
					<label class="small"><spring:message code="ordinance.number" text="Number"/></label>
				...
				<div>
					<fieldset>
						<legend style="text-align: left; width: 150px;"><label><spring:message code="ordinance.titles" text="Titles of ordinance" /></label></legend>
						<div id="titles_div">
							<c:forEach var="i" items="${titles}">
								<p>
									<label class="centerlabel">${i.language.name} <spring:message code="ordinance.title" text="Title"/></label>
				...
				<p>
					<label class="small"><spring:message code="ordinance.fileMarathi" text="Ordinance File In Marathi"/></label>
					<c:choose>		
				...
				<p>
					<label class="small"><spring:message code="ordinance.fileEnglish" text="Ordinance File In English"/></label>
					<c:choose>		
				...
				<p>
					<label class="small"><spring:message code="ordinance.fileHindi" text="Ordinance File In Hindi"/></label>
					<c:choose>		
