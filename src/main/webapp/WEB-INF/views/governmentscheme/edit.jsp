...
<head>
	<title>
	<spring:message code="governmentscheme" text="Government Scheme"/>
	</title>
...
<form:form action="governmentscheme" method="PUT"  modelAttribute="domain">
	...
	<p>
	<label class="small"><spring:message code="governmentscheme.name" text="Government Scheme"/>&nbsp;*</label>
