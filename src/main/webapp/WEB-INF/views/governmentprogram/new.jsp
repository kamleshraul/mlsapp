...
<html>
<head>
<title><spring:message code="governmentprogram" text="Government Programs" />
</title>
...
<div class="fields clearfix vidhanmandalImg">
		<form:form action="governmentprogram" method="POST"
			...
			<p>
				<label class="small"><spring:message
						code="governmentprogram.name" text="Government Program" />&nbsp;*</label>
				<form:input cssClass="sText " path="name" />
				<form:errors path="name" cssClass="validationError" />
			</p>
			<p>
				<label class="small"><spring:message
						code="governmentprogram.identificationkey" text="Key" />&nbsp;*</label>
