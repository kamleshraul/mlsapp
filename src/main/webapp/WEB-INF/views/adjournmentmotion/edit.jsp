...
<head>
	...
	$(document).ready(function(){
		...
		if($("#currentStatus").val()=='adjournmentmotion_submit'){
			$("#ministry").attr("disabled","disabled");
			$("#subDepartment").attr("disabled","disabled");
			$("#subject").attr("readonly","readonly");
			$("#adjourningDate").attr("disabled","disabled");
			$("#subject").attr("readonly","readonly");
			$("#noticeContent").attr("readonly","readonly");
		}
		
		$('#new_record_ForNew').click(function(){	
			newAdjournmentMotion_ForNew();
		});
	});
	/**** new motion ****/
	function newAdjournmentMotion_ForNew() {
		showTabByIdAndUrl('details_tab','adjournmentmotion/new?'+$("#gridURLParams_ForNew").val());
	}
	</script>
</head>
	...
	<div class="fields clearfix watermark">
		...
		<form:form action="adjournmentmotion" method="PUT" modelAttribute="domain">
			...
			<p>
			 ...
			 <div class="fields">
				<h2></h2>
				<c:if test="${memberStatusType=='adjournmentmotion_complete' or memberStatusType=='adjournmentmotion_incomplete'}">
				<p class="tright">
