...
<script type="text/javascript">
	$(document).ready(function(){	
		...
		$("#amois_register_admission_number_report").click(function() {
			$(this).attr('href','#');
	...
	function generateRegisterReport() {
		...
		$("#amois_register_admission_number_report").attr('href',
	...
	function bulkUpdateAdmissionNumberChange(){
	    ...
	    $.prompt($('#submissionMsg').val(),{
	        ...
	        if(v){
				...
				$.ajax({url: 'adjournmentmotion/bulkadmissionmotionnumberapproval/update', 
					data: {						
						 items:admission,
...
<a href="#" id="amois_register_admission_number_report" class="butSim">
...
<p id="error_p" style="display: none;">&nbsp;</p>
	...
	<c:choose>
		  ...
		  <div style="overflow: scroll;">
			<table class="uiTable">
				<tr>					
					...
					<th style="min-width:50px;"><spring:message code="adjournmentMotion.number" text="Number"></spring:message></th>
		...
		<c:otherwise>
			<spring:message code="resolution.noresolutions" text="No Adjournment Motion Found"></spring:message>				
		</c:otherwise>
	</c:choose>
<%-- 	<input type="hidden" id="resolutionId" value="${resolutionId}"> --%>
	<input id="submissionMsg" value="<spring:message code='adjournmentmotion.client.prompt.submit' text='Do you want change the admission Number of Adjournment Motion ?'></spring:message>" type="hidden">
