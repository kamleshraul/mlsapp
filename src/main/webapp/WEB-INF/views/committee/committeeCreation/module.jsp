...
<head>
	...
	<script type="text/javascript">
		...
		function showList() {
			...
			showTabByIdAndUrl('list_tab','committee/adminCommitteeCreation/list');
		}	
		function newRecord() {
		...
		function editRecord(row) {
			...
			showTabByIdAndUrl('details_tab','committee/adminCommitteeCreation/'+row+'/edit'); 
		...
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			...
			showTabByIdAndUrl('details_tab', 'committee/adminCommitteeCreation/'+rowid+'/edit'); 
			//console.log("Working for row Clicker")
		}	
...
<body>
	...
	<div class="clearfix tabbar">
		...
		<input type="hidden" id="urlPattern" name="urlPattern" value="${urlPattern}">
			<input type="hidden" id="gridURL" value="/els/grid/data/">
