			...
			<div id="reportDiv">
				...
				<br>
				 <div style="width: 750px;">
					...
					<br>
					<div style="font-weight: bold; width: 700px; margin: 0px 0px 10px 25px;">
						${labels[2]} - ${report[0][6]} (${report[0][15]})
					</div>
					<br>
					...
					<table style="width: 700px; border: 1px solid black;" border="1" align="center" class="strippedTable">  
						<thead>
							<tr>
								...
								<th style="width: 60px;">${topHeader[4]}</th>
						...
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
								...
								<tr class="page-break">
									...
									<%-- <td style="width: 50px; text-align: center;">${r[10]}</th> --%>
									<td style="width: 60px; text-align: center;">${r[10]}</th>
									<td style="width: 50px; text-align: center;">${r[11]}</th>
								</tr>	
					...
					<div style="font-weight: bold;  width: 715px;  margin: 10px">
						${labels[5]} - ${report[0][12]}&nbsp;&nbsp;${labels[6]} - ${report[0][13]}&nbsp;&nbsp;
						${labels[7]} - ${report[0][14]}<%-- &nbsp;&nbsp;${labels[8]} - ${report[0][16]} --%>
					</div>
				</div>
			</div>
		</c:otherwise>
