...
<head>
	<title>
	<spring:message code="resolution.statusreport" text="Status Report"/>
	</title>
	...
	<script type="text/javascript">
		...
		function addRemarkReport(){
			if(ids.length > 0 && counter < ids.length){
				 $.get('resolution/report/'+ ids[counter] + '/currentstatusreportvm?device='+$("#device").val(),function(data1){
...
<input type="hidden" id="rIDs" value="${rId}" />
