			...
			<c:when test="${report != null and not (empty report)}">
				...
				<div style="width: 750px; margin-left: 20px;">
					<table class="strippedTable" border="1" style="width: 750px;">
						<thead>
							<tr>
								<th style="text-align: center; font-size: 12px; width: 20px;">${topHeader[1]}</th>
								<th style="text-align: center; font-size: 12px; width: 90px;">${topHeader[2]}</th>
								<th style="text-align: center; font-size: 12px; width: 300px;">${topHeader[3]}</th>
						...
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
												<tr >
													<td style="text-align: center; font-size: 12px; width: 20px;">${r[1]}</td>
													<td style="text-align: center; font-size: 12px; width: 90px;">${r[2]}</td>
													<td style="text-align: left; font-size: 12px; width: 300px;">${r[3]}</td>
