...
<form:form action="eventmotion" method="PUT" modelAttribute="domain">
	...
	<p style="display:none;" class="revise1" id="revisedEventTitleDiv">
		...
		<form:textarea path="revisedEventTitle" rows="2" cols="50" readonly="true"></form:textarea>
	...
	<p style="display:none;" class="revise4" id="revisedDescriptionDiv">
		...
		<form:textarea path="revisedDescription" cssClass="wysiwyg" readonly="true"></form:textarea>
	...
	<p>
		...
		<form:textarea path="remarks" cssClass="wysiwyg" readonly="readonly"></form:textarea>
	</p>	
		...
		<p class="tright">		
			<c:if test="${bulkedit!='yes'}">
				<c:if test="${internalStatusType=='eventmotion_submit' ||
								internalStatusType=='eventmotion_system_assistantprocessed'}">
