...
<head>
	<title>
	<spring:message code="fort" text="Forts"/>
	</title>
...
<form:form action="fort" method="PUT"  modelAttribute="domain">
	...
	<form:errors path="version" cssClass="validationError"/>
			...
			<p>
				<label class="small"><spring:message
						code="fort.name" text="Fort" />&nbsp;*</label>
			...
			<p>
				<label class="small"><spring:message
						code="fort.identificationkey" text="Key" />&nbsp;*</label>
