					...
					<table style="width: 700px; border: 1px solid black;" border="1" align="center" class="strippedTable">  
						<thead>
							<tr>
								...
								<th style="width: 380px;">${topHeader[1]}</th>
								<th style="width: 95px;">${topHeader[2]}</th>
								<th style="width: 95px;">${topHeader[3]}</th>
						...
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
								...
								<tr class="page-break">
									...
									<td style="width: 380; text-align: left;">${r[6]}</th>
									<td style="width: 95px; text-align: center;">${r[7]}</th>
									<td style="width: 95px; text-align: center;">${r[8]}</th>
									<td style="width: 100px; text-align: center;">${r[9]}</th>
								</tr>	
							</c:forEach>
						</tbody>
					</table>
