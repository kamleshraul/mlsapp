				...
				<br>
				 <div style="width: 750px;">
					...
					<table style="width: 700px; border: 1px solid black;" border="1" align="center" class="strippedTable">  
						<thead>
							<tr>
								...
								<th style="width: 3800px;">${topHeader[3]}</th>
								...
								<th style="width: 50px;">${topHeader[9]}</th>
							</tr>						
						</thead>
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
								...
								<tr class="page-break">
									...
									<td style="width: 120px;">${r[6]}</th>
									<td style="width: 380px;">${r[8]}</th>
									<td style="width: 50px;">${r[9]}</th>
									<td style="width: 60px;">${r[10]}</th>
									<td style="width: 50px; text-align: center;">${r[7]}</th>
									<td style="width: 50px;">${r[12]}</th>
									<td style="width: 50px;">${r[13]}</th>
					...
					<div style="font-weight: bold;  float: rigth; width: 715px; text-align: right; margin: 10px">
						${labels[2]}&nbsp;${formater.formatNumberNoGrouping(total, locale)}
					</div>
					<div style="font-weight: bold;  width: 715px;  margin: 10px">
						${labels[3]} - ${report[0][14]}&nbsp;&nbsp;${labels[4]} - ${report[0][15]}&nbsp;&nbsp;
						${labels[5]} - ${report[0][16]}&nbsp;&nbsp;${labels[6]} - ${report[0][17]}&nbsp;&nbsp;
						${labels[7]} - ${report[0][18]}
					</div>
				</div>
			</div>
		</c:otherwise>
