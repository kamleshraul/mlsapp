...
<head>
	<title>
	<spring:message code="motion.statusreport" text="Status Report"/>
	</title>
	...
	<script type="text/javascript">
		...
		function showRemarkReport(){
			...
			'&subdepartment='+(($("#selectedSubDepartment").val()=='' || $("#selectedSubDepartment").val()==undefined)?'0':$("#selectedSubDepartment").val())+ 
			'&grid='+ strLocation + 
			'&group='+(($("#selectedGroup").val()=='' || $("#selectedGroup").val()==undefined)?'0':$("#selectedGroup").val())+
...
<input type="hidden" id="qIDs" value="${moId}" />
