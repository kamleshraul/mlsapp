...
<c:when test="${errorcode eq 'cmois_allowed_usergroups_notset'}">
	<div class="toolTip tpRed clearfix">
		<p>
			<img src="./resources/images/template/icons/light-bulb-off.png">
			<spring:message code="cutmotion.errorcode.qis_allowed_usergroups_notset" text="Custom Parameter 'CMOIS_ALLOWED_USERGROUPTYPES' not set"/>
		</p>
		<p></p>
	</div>
</c:when>
...
<c:when test="${errorcode eq 'cutmotion_putup_options_final_notset'}">
	<div class="toolTip tpRed clearfix">
		<p>
			<img src="./resources/images/template/icons/light-bulb-off.png">
			<spring:message code="cutmotion.errorcode.question_putup_options_final_notset" text="Custom Parameter 'CUTMOTION_PUT_UP_OPTIONS_FINAL' not set"/>
		</p>
		<p></p>
	</div>
</c:when>
