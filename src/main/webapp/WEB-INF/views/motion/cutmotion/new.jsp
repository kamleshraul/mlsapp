...
<body>
	...
	<div class="fields clearfix watermark">
		...
		<form:form action="motion/cutmotion" method="POST" modelAttribute="domain">
			...
			<div id="reportDiv">
			 ...
			 <div class="fields">
				...
				<p class="tright">
					<security:authorize access="hasAnyRole('CMOIS_CLERK')">	
						<input id="submitCutMotion" type="button" value="<spring:message code='motion.submitmotion' text='Submit Motion'/>" class="butDef">			
					</security:authorize>
					<security:authorize access="hasAnyRole('MEMBER_LOWERHOUSE','MEMBER_UPPERHOUSE')">		
