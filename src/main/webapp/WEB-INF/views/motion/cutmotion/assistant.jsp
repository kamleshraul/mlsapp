...
<head>
	...
	$(document).ready(function(){
		...
		$("#viewCitation").click(function(){
			$.get('cutmotion/citations/'+$("#type").val()+ "?status=" + $("#internalStatus").val(),function(data){
...
<form:form action="cutmotion" method="PUT" modelAttribute="domain">
	...
	<h2>${formattedCutMotionType}: ${formattedNumber}</h2>
	...
	<p style="display:none;">
		...
		<input id="formattedCutMotionType" name="formattedCutMotionType" value="${formattedCutMotionType}" class="sText" readonly="readonly">
		<input id="deviceType" name="deviceType" value="${cutMotionType}" type="hidden">		
	...
	<p>
	<label class="small"><spring:message code="cutmotion.subdepartment" text="Sub Department"/></label>
	...
	<p>
		<label class="centerlabel"><spring:message code="cutmotion.members" text="Members"/></label>
	...
	<c:if test="${selectedCutMotionType=='cutmotions_budgetary'}">
		<p>	
	...
	<p style="display:none;" class="revise1" id="revisedSecondaryTitleDiv">
	...
	<p style="display:none;" class="revise1" id="revisedSubTitleDiv">
	...
	<p style="display:none;" class="revise2" id="revisedContentDiv">
