...
<html>
<head>
<title><spring:message code="governmentcorporation" text="Government Corporations" />
</title>
...
<div class="fields clearfix vidhanmandalImg">
		<form:form action="governmentcorporation" method="POST"
			...
			<p>
				<label class="small"><spring:message
						code="governmentcorporation.name" text="Government Corporation" />&nbsp;*</label>
				<form:input cssClass="sText " path="name" />
				<form:errors path="name" cssClass="validationError" />
			</p>
			<p>
				<label class="small"><spring:message
						code="governmentcorporation.identificationkey" text="Key" />&nbsp;*</label>
