...
<head>
	<title>
	<spring:message code="dam" text="Dams"/>
	</title>
...
<form:form action="dam" method="PUT"  modelAttribute="domain">
	...
	<p>
	<label class="small"><spring:message code="dam.name" text="Dam"/>&nbsp;*</label>
			<form:input cssClass="sText" path="name"/>
			<form:errors path="name" cssClass="validationError"/>	
	</p>
	<p>
	<label class="small"><spring:message code="dam.district" text="District" />&nbsp;*</label>
	...
	<p>
	<label class="small"><spring:message code="dam.identificationkey" text="Key"/>&nbsp;*</label>
