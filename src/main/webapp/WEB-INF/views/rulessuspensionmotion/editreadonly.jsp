	...
	<head>
		...
		$(document).ready(function(){
		    ...
		    $("#readonly_viewRevision").click(function(){
		    	$.get('rulessuspensionmotion/revisions/'+$("#readonly_id").val(), function(data){
		    		$.fancybox.open(data);			    	
			    });
			    return false;
		    });
			...
			<div id="readonly_assistantDiv">
				<form:form id="readonly_currentForm" modelAttribute="domain">
					...
					<p>
						...
						<input id="readonly_formattedRulesSuspensionDate" value="${formattedRulesSuspensionDate}" class="sText" readonly="readonly">
						<input id="readonly_ruleSuspensionDate" type="hidden"  value="${selectedRuleSuspensionDate}">
					</p>		
					...
					<p>
						<label class="small"><spring:message code="rulessuspensionmotion.ministry" text="Ministry"/></label>
						...
						<label class="small"><spring:message code="rulessuspensionmotion.subdepartment" text="Sub Department"/></label>
					...
					<p>
						...
						<c:choose>
							<c:when test="${!(empty clubbedMotions) }">
								...
								<a href="javascript:void(0);" id="readonly_viewClubbedRulesSuspensionMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="rulessuspensionmotion.clubbed.texts" text="C"></spring:message></a>
							</c:when>
							<c:otherwise>
								<c:out value="-"></c:out>
							</c:otherwise>
					...
					<p>
						...
						<c:choose>
							<c:when test="${!(empty referencedMotion) }">
								...
								<%-- <a href="javascript:void(0);" id="readonly_viewReferencedMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="rulessuspensionmotion.referenced.texts" text="R"></spring:message></a> --%>
								<input type="hidden" id="readonly_referencedRulesSuspensionMotion" value="${referencedMotion.id}">
							</c:when>
							<c:otherwise>
								<c:out value="-"></c:out>
							</c:otherwise>
					...
					<p>
						<a href="#" id="readonly_viewRevision" style="margin-left: 162px;margin-right: 20px;"><spring:message code="rulessuspensionmotion.viewrevisions" text="View Revisions"></spring:message></a>
					</p>	
				...
				<input id="readonly_startWorkflowMessage" value="<spring:message code='rulessuspensionmotion.startworkflowmessage' text='Do You Want To Put Up Question?'></spring:message>" type="hidden">
