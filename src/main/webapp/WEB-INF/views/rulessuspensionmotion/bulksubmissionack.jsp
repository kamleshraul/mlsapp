...
<body>	
	...
	<table class="uiTable">
		<tr>
			<th><spring:message code="adjournmentmotion.number" text="Number"></spring:message></th>
		...
		<c:forEach items="${adjournmentMotions}" var="i" varStatus="cnt">
			<tr>
				<td>${i.formatNumber()}</td>
				<td class="adjourningDate" id="adjourningDate${cnt.count}">${i.formattedAdjourningDate}</td>
