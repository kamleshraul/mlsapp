...
<c:choose>
	<c:when test="${empty reportData}">
		<h3><spring:message code="partywise_questions_count_report.noentriesfound" text="No Entries Found."/></h3>
	</c:when>
	<c:otherwise>
		<div id="reportDiv" >
			<div align="center">${reportHeaders[0][0]}</div>
			<h4 style="margin-left: 25px;">
				<div style="margin-top: 30px; font-weight: bold;">${reportHeaders[0][2]}</div>
				<div style="margin-top: 10px; font-weight: bold;">${reportHeaders[0][3]}</div>
			</h4>			
