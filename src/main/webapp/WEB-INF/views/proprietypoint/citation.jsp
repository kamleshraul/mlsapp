...
<html>
<head>
<title><spring:message code="proprietypoint.citation"	text="Citations" /></title>
...
Citations'/>" class="butDef">
	...
	<c:otherwise>
		<spring:message code="proprietypoint.no citations" text="No citations found"></spring:message>
	</c:otherwise>
</c:choose>	
