...
<head>
	<title>
	<spring:message code="proprietypoint.title.new" text="Propriety Point"/>
	</title>
...
<body>
	...
	<div class="fields clearfix watermark">
		...
		<form:form action="proprietypoint" method="POST" modelAttribute="domain">
			<%@ include file="/common/info.jsp" %>
			<div id="reportDiv">
			<h2><spring:message code="proprietypoint.new.heading" text="Enter New Propriety Point Details"/></h2>
