...
<head>
	<title>
		<spring:message code="zillaparishad" text="zillaparishads"/>
	</title>
...
<form:form  action="zillaparishad" method="POST" modelAttribute="domain">
	...
	<form:errors path="version" cssClass="validationError"/>	
	 <p>
	<label class="small"><spring:message code="zillaparishad.state" text="State"/>&nbsp;*</label>
	...
	<p>
	<label class="small"><spring:message code="zillaparishad.district" text="District"/>&nbsp;*</label>
	...
	<p>
	<label class="small"><spring:message code="zillaparishad.name" text="Name"/>&nbsp;*</label>
