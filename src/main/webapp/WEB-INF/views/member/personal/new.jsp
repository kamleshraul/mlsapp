...
<head>
	...
	$(document).ready(function(){	
		...
		//initially a new record will mean that he/she will be member of the selected assembly/council
		$("#isMember").attr("checked","checked");
		...
		$("#noOfSons").change(function(){
			...
			if(sons>1){
				$("#sonLabel").empty();
				$("#sonLabel").text($("#sonsMsg").val());				
			}else{
				$("#sonLabel").empty();			
				$("#sonLabel").text($("#sonMsg").val());				
			}
			autoAddFamily();
		});		
...
<form:form action="member/personal" method="POST" modelAttribute="domain">
	...
	<p>
		<label class="small"><spring:message code="member.personal.isMember" text="Is Member?"/></label>
		<input type="checkbox" id="isMember" name="isMember" value="true" class="sCheck"/>			
	</p>
	<p>
	...
	<p>
		...
		<input type="text" class="sText" id="spouseName1" name="spouseName1" value="${spouseName1}"/>
		...
		<input type="text" class="sText" styles="padding-left:400px;" id="spouseName2" name="spouseName2" value="${spouseName2}"/>
