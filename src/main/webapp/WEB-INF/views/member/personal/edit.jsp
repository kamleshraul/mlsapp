	...
	function addFamily(){
		...
		var text="<div id='family"+familyCount+"'>"+
				  ...
				  "<p>"+
					  ...
					  "<input type='hidden' id='familyMemberLocale"+familyCount+"' name='familyMemberLocale"+familyCount+"' value='${domain.locale}'>"+
	...
	function addQualification(){
		...
		var text="<div id='qualification"+qualificationCount+"'>"+
        		 ...
        		 "<select name='qualificationDegree"+qualificationCount+"' id='qualificationDegree"+qualificationCount+"' class='sSelect'>"+
				  ...
				  "<input type='hidden' id='qualificationLocale"+qualificationCount+"' name='qualificationLocale"+qualificationCount+"' value='${domain.locale}'>"+
...
<form:form action="member/personal" method="PUT" modelAttribute="domain">
	...
	<p>
	    <label class="small"><spring:message code="${urlPattern}.qualificationDetail" text="Details"/></label>
		<textarea name="qualificationDetail${count}" id="qualificationDetail${count}" class="sTextarea">${outer.details}</textarea>
	</p>	
	<input type='button' class='button' id='${count}' value='<spring:message code="${urlPattern}.deleteQualification" text="Delete Qualification"></spring:message>' onclick='deleteQualification(${count});'/>
	<c:set var="count" value="${count+1}"></c:set>
