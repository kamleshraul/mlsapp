...
<html>
<head>
	<title><spring:message code="motion_information_system" text="List of Motions"/></title>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','motion_information/list');
		});
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','motion_information/new')	;
		}
		...
		function editRecord(row) {
			...
			showTabByIdAndUrl('details_tab','motion_information/'+row+'/edit');
		}
		...
		function deleteRecord(row) {
			if(row==null){
				...
				$.prompt('Are you sure you want to delete the record with Id: '+ row,{
			        ...
			        if(v){
				        $.delete_('motion_information/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
				            showList();
				        });
			        }
				}});
		...
		function editContactDetails(row) {
			if(row == null || row == ''){
				...
				showTabByIdAndUrl('contact_tab','motion_information/'+row+'/edit');
			}
		}
		...
		function editOtherDetails(row) {
			if(row == null || row == ''){
				...
				showTabByIdAndUrl('other_tab','motion_information/'+row+'/edit');
			}
		}
		
		function rowDblClickHandler(rowid, iRow, iCol, e) {
			showTabByIdAndUrl('details_tab', 'motion_information/'+rowid+'/edit');
		}
	</script>
</head>
<body>
		...
		<ul class="tabs">
			<li>
				<a id="list_tab" class="selected tab" href="#">
					<spring:message code="mois.module.list" text="List"></spring:message>
				</a>
			</li>
			<li>
