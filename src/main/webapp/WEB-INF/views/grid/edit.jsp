...
<body>
<form:form cssClass="wufoo" action="grid" method="PUT" modelAttribute="grid">
	<div class="info">
		<h2>Grid [Id:${grid.id}]</h2>
	...
	<ul>
		...
		<label class="desc">Page Size&nbsp;*</label>
			<div>
				<form:input cssClass="field text small" path="pageSize"/><form:errors path="pageSize" cssClass="field_error" />
			</div>
		</li>
		<li>
		...
		<label class="desc">Width&nbsp;*</label>
			<div>
				<form:input cssClass="field text small" path="width"/><form:errors path="width" cssClass="field_error" />
			</div>
		</li>
		<li>
		<label class="desc">Height&nbsp;*</label>
			<div>
				<form:input cssClass="field text small" path="height"/><form:errors path="height" cssClass="field_error" />
			</div>
		</li>
		<li>
