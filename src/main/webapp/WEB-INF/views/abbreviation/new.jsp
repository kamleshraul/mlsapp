...
<html>
<head>
<title><spring:message code="abbreviation" text="Abbreviations" />
</title>
...
<div class="fields clearfix vidhanmandalImg">
		<form:form action="abbreviation" method="POST"
			...
			<p>
				<label class="small"><spring:message
						code="abbreviation.name" text="name" />&nbsp;*</label>
				<form:input cssClass="sText " path="name" />
				<form:errors path="name" cssClass="validationError" />
			</p>
			<p>
				<label class="small"><spring:message
						code="abbreviation.abbreviation" text="Abbreviation" />&nbsp;*</label>
				<form:input cssClass="sText " path="abbreviation" />
				<form:errors path="abbreviation" cssClass="validationError" />
			</p>
			<p>
				<label class="small"><spring:message
						code="abbreviation.identificationkey" text="identificationkey" />&nbsp;*</label>
