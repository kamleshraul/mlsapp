...
<head>
	<title>
	<spring:message code="groupinformation.rotationorder.edit" text="Question Dates"/>
	</title>
...
<form:form action="groupinformation/rotationorder" method="POST" modelAttribute="domain">
	...
	<p>
		...
		<form:input cssClass="sText" path="group.name" readonly="true"/>
	</p>	
	<p>
	...
	<p>
		<table>
			<tr>
				<td valign="middle">				
					<label class="small"><spring:message code="groupinformation.rotationorder.selectDates" text="Rotation Order"/></label>
				</td>
				<td>
					<table>
						<tr>
							<th><spring:message code="groupinformation.rotationorder.select" text="Select"/></th>
							<th></th>
							<th></th>				
							<th><spring:message code="groupinformation.rotationorder.anweringDate" text="Answering Date"/></th>		
							<th></th>
							<th></th>	
							<th></th>
							<th></th>
							<th></th>
							<th></th>
							<th><spring:message code="groupinformation.rotationorder.submissionDate" text="Last Submission Date"/></th>
						</tr>
						<tr></tr>
	...
	<input type="hidden" id="errorMsg" value='<spring:message code="groupinformation.rotationorder.errormsg"/>'>
