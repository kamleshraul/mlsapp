...
<form:form  action="groupinformation" method="PUT" modelAttribute="domain">
	...
	<p>
		<label class="small"><spring:message code="groupinformation.ministries" text="Ministries" /></label>			
