											...
											<tr class="page-break" style="margin-top: 5px;">
												<td>
													<table callpadding="0">
														<br>
														<tr>
															<td style="width: 50px; max-width: 50px;"><span class="ministryReportMemberName ">(${mi[0]})</span></td>
															<td style="width: 700px; max-width: 700px;">
																<table>
																	<tr>
																		<td rowspan="2" style="width: 270px;">
																			<span class="ministryReportMemberName" style="text-align: left; word-wrap: break-word; display:inline;">${mi[1]} --- </span>	
																		</td>
																		<td>
																			<span class="ministryReportMinistryName" style="display: inline;">${mi[5]}</span>
																		</td>
																	</tr>																	
																</table>																
															</td>
