...
<head>
	...
	function deleteNonCommitteeMemberInfo(id) {
		...
		if(noncommitteemembersInfoId != ''){		
	    	...
	    	/*$.delete_('prashnavali/info/' + noncommitteemembersInfoId + '/delete', 
	    	    null, 
...
<form:form action="committeemeeting/noncommitteemembers" method="PUT" modelAttribute="domain">
	...
	<div>
		<input type="button" id="addNonCommitteeMemberInfo" class="button" value="<spring:message code='prashvali.addPrasnavaliInfo' text='Add Member Information'></spring:message>">
		...
		<c:if test="${not empty noncommitteemembers}">
			...
			<c:forEach items="${noncommitteemembers}" var="outer">
				<div id="noncommitteemembersInfo${noncommitteemembersCount}">
					...
					<input type='button' id='${noncommitteemembersCount}' class='button' value='<spring:message code="noncommitteemember.info.delete" text="Delete Info"></spring:message>' onclick='deleteNonCommitteeMemberInfo(${noncommitteemembersCount});'/>
		...
		<input type="hidden" id="nonCommitteeMemberMessage" name="nonCommitteeMemberMessage" value="<spring:message code='Memberinfo.noncommitteemember' text='Member'></spring:message>" disabled="disabled"/>
