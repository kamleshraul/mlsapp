...
<form:form action="prashnavali" method="PUT" >
			...
			<c:forEach items="${questions}" var="outer">
				<div id="prasInfo${questionCount}">
					<p>
						...
						<input id="question${questionCount}" name="question${questionCount}" class="sTextarea" readonly="readonly" value="${outer.question}">
				
						<label class="small"><spring:message code="prashnavalinfo.answer" text="Answer"/>*</label>
						<input id="answer${questionCount}" name="answer${questionCount}" class="sTextarea" value="${outer.answer}">
					</p>
