...
<html lang="en">
	...
	<c:choose>
		<c:when test="${not empty memberDesignation}">
        ...
        <div id="content">
            <section class="full-bleed profile-section">
                <div class="section-body style-default-dark force-padding text-shadow">
                    ...
                    <!--end .row -->
                    <br>
                    <div class="overlay overlay-shade-bottom stick-bottom-left force-padding text-right" style="display:none;">
                        <div class="row">
                            <div class="col-md-6">
            ...
            <section class="main-content">
                ...
                <div class="section-body m-t-n">
                    <div class="row  row-eq-height clearfix">
                    	<c:choose>
							<c:when test="${empty memberDesignation}">
