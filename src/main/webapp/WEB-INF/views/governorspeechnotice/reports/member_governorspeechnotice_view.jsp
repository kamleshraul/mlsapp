...
<head>
	<title>
	<spring:message code="governorspeechnotice.member_governorspeechnotice_view" text="Member's Governor Speech Notice"/>
	</title>
...
<body>
	...
	<div id="reportDiv">
		<c:choose>
										...
										<c:choose>
											<c:when test="${counter.count > 1}">
												<tr class="page-break-after-forced">
													...
													<td style="text-align: center; font-size: 12px; width: 300px; vertical-align: top;">${r[3]}</td>													
													<!--<td style="text-align: left; font-size: 12px; width: 90px; vertical-align: top;">${r[5]}</td> -->
													<%-- <td style="text-align: center; font-size: 12px; width: 60px; vertical-align: top;">${r[4]}</td> --%>
												</tr>
											</c:when>
											<c:otherwise>
												<tr>
			...
			<c:otherwise>
				<spring:message code="member_governorspeechnotice_view.nodatafound" text="No Data Found"/>
			</c:otherwise>
		</c:choose>
	</div>
</body>
