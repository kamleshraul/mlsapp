...
<head>
	...
	/* 		var selectedSpecialMentionNoticeDate = "";
			...
			$('#new_record').click(function(){				
				...
				$.get('ref/governorspeechnotice/numberofnotices?sessionId='+$("#loadedSession").val()
			...
			/****Member's Governor Speech Notice  View ****/
			$("#member_governorspeechnotice_view").click(function() {
				$("#selectionDiv1").hide();
				memberGovernorSpeechNoticeView();
			});
			...
			$('#admissionNumberChange').click(function(){
				showTabByIdAndUrl('details_tab', 'gvernorspeechnotice/bulkview/admissionnumber?houseType='+$('#currentHouseType').val());
			});
...
<body>
	...
	<div class="commandbar">
		...
		<!-- 		<hr/> -->
			...
			<security:authorize access="hasAnyRole('MEMBER_LOWERHOUSE','MEMBER_UPPERHOUSE')">
				<hr/>
				<a href="#" style="display: none;" id="member_governorspeechnotice_view" class="butSim">
					<spring:message code="governorspeechnotice.member_governorspeechnotice_view" text="Member's Governor Speech Notice View"/>
				</a> |
			</security:authorize>				
			<p>&nbsp;</p>
		</div>
	...
	<input id="errorMessage" value="<spring:message code='governorspeechnotice.numberOfNoticesExceeding' text='Only 10 Notices are allowed to submit'/>" type="hidden">
	</div>
