							...
							<tr>
								...
								<c:choose>
									<c:when test="${r1[9]!=null}">
										<c:choose>
											<c:when test="${r1[6]!=null and r1[6]!=''}">
												<b>${r1[10]}</b>	
											</c:when>
											<c:otherwise>
												${r1[10]}
										...
										<c:if test="${r1[20]!=null and r1[20]!=''}">
											(${r1[20]})
										</c:if>
										<c:choose>
											<c:when test="${r1[21]!=null and r1[21]!=''}">
												(<b>${r1[21]}</b>
												<c:if test="${r1[6]!=null and r1[6]!='' }">
													<b>${r1[6]}</b>)
												</c:if>
											</c:when>
											<c:otherwise>
										...
										<c:if test="${r1[11]!=null }">
											<c:choose>
												<c:when test="${r1[7]!=null and r1[7]!=''}">
													,<b>${r1[11]} (${r1[7]})</b>
												</c:when>
												<c:otherwise>
													,${r1[11]}
