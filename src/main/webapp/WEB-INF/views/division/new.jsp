...
<form:form  action="division" method="POST" modelAttribute="domain">
	...
	<form:errors path="version" cssClass="validationError"/>		 
		<p> 
			...
			<form:select path="state" items="${states}" itemValue="id" itemLabel="name" cssClass="sSelect"></form:select>	
