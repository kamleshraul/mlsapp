...
<head>
	...
	function viewContent(){
		...
		var resource='standalonemotion/yaaditodiscussupdate/assistant/view';
	...
	function bulkUpdate(){
		...
		$.prompt($('#submissionMsg').val(),{
	        ...
	        if(v){
				...
				$.post('standalonemotion/yaaditodiscussupdate/assistant/update?loadIt=yes',
			        	{items:items
...
<body>	
	...
	<input type="hidden" id="ydquestionType" value="${deviceType}">
