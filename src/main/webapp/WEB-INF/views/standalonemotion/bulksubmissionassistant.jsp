			...
			$.prompt($('#submissionMsg').val(),{
		        ...
		        if(v){
		        	...
		        	$.post('question/bulksubmission/assistant?items='+items
		        			+"&usergroupType="+$("#usergroupType").val()+"&remark="+$("#remarks").val()
	...
	<c:choose>
		<c:when test="${!(empty questions) }">
			<p>
				...
				<textarea name="remarks" id="remarks" class="sText" rows="5" cols="30"></textarea>
			</p>
			<p>
				<label class="centerlabel"><spring:message code="question.reftext" text="Reference Text"/></label>
				<textarea name="refText" id="refText" class="sText" rows="5" cols="30"></textarea>
			</p>
