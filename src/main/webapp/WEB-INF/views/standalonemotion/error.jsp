...
<c:when test="${errorcode eq 'qis_allowed_usergroup_to_do_view_clubbing_referencing_not_set'}">
	<div class="toolTip tpRed clearfix">
		<p>
			<img src="./resources/images/template/icons/light-bulb-off.png">
			<spring:message code="question.errorcode.qis_allowed_usergroup_to_do_view_clubbing_referencing" text="SMOIS_ALLOWED_USERGROUP_TO_DO_VIEW_CLUBBING_REFERENCING not set."/>
		</p>
		<p></p>
	</div>
</c:when>
...
<c:when test="${errorcode eq 'current_user_has_no_usergroups'}">
	<div class="toolTip tpRed clearfix">
		<p>
			<img src="./resources/images/template/icons/light-bulb-off.png">
			<spring:message code="question.errorcode.current_user_has_no_usergroups" text="No SMOIS usergroup set for current user"/>
		</p>
		<p></p>
	</div>
</c:when>
<c:when test="${errorcode eq 'question_status_allowed_by_default_not_set'}">
	<div class="toolTip tpRed clearfix">
		<p>
			<img src="./resources/images/template/icons/light-bulb-off.png">
			<spring:message code="question.errorcode.question_status_allowed_by_default_not_set" text="Custom Parameter 'STANDALONE_STATUS_ALLOWED_BY_DEFAULT' not set"/>
		</p>
		<p></p>
	</div>
</c:when>
