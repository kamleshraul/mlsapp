					...
					<table style="width: 700px; border: 1px solid black;" border="1" align="center" class="strippedTable">  
						<thead>
							<tr>
								...
								<th style="width: 50px;"><spring:message code="question.hdq.report.group" text="Group" /></th>
								<th style="width: 200px;"><spring:message code="question.hdq.report.status.subject" text="Subject" /></th>
						...
						<tbody>
							<c:forEach items="${report}" var="r" varStatus="counter">
								<tr>
									...
									<td style="width: 40px; text-align: center;">${r[9]}</td>
									<td style="width: 280px; text-align: center;">${r[3]}</td>
