...
<html>
<head>
	<title><spring:message code="field.new.title" text="Customize Fields"/></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
</head>
<body>
<form:form cssClass="wufoo" action="fields" method="POST" modelAttribute="field">
	<div class="info">
		<h2><spring:message code="generic.new.heading" text="New Field"/></h2>
		<div style="background-color:#C1CDCD; ;padding: 3px"><spring:message code="generic.mandatory.label" text="Field marked * are mandatory"/></div>
	</div>
	<ul>	
		<li>
