...
<html>
<head>
	<title><spring:message code="assemblynumber.edit.title"/></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
</head>
<body>
<form:form cssClass="wufoo" action="assembly_number" method="PUT" 
	modelAttribute="assemblyNumber">
	<div class="info">
		<h2><spring:message code="assemblynumber.edit.heading"/> [Id:${assemblyNumber.id}]</h2>
