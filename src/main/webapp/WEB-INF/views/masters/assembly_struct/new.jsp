...
<html>
<head>
	<title><spring:message code="assemblystruct.new.title"/></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
</head>
<body>
<form:form cssClass="wufoo" action="assembly_struct" method="POST" 
	modelAttribute="assemblyStructure">
	<div class="info">
		<h2><spring:message code="assemblystruct.new.heading"/></h2>
