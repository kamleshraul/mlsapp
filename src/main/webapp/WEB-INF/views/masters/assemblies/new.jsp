...
<html>
<head>
	<title><spring:message code="assembly.new.title"/></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	</head>
<body>
<form:form cssClass="wufoo" action="assemblies" method="POST" modelAttribute="assembly">
	<div class="info">
		<h2><spring:message code="assembly.new.heading"/></h2>
	...
	<ul>			
		...
		<label class="desc"><spring:message code="assembly.assemblyNumber"/>&nbsp;*</label>
			<div>
	            ...
	            </form:select><form:errors path="assemblyNumber" cssClass="field_error"></form:errors>			
	        </div>
		</li>		
		<li>
