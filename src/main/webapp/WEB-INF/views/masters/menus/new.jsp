...
<head>
	<title>
	<spring:message code="${urlPattern}" text="Menus"/>
	</title>
...
<form:form action="${urlPattern}" method="POST"  modelAttribute="domain">
	...
	<p>
	<label class="small"><spring:message code="${urlPattern}.parent" text="Parent Menu"/></label>
	...
	<p>
		<label class="small"><spring:message code="${urlPattern}.textkey" text="Text Key"/>&nbsp;*</label>
			<form:input cssClass="sSelect" path="textKey"/>
			<form:errors path="textKey" cssClass="validationError" />	
	</p>
	<p>
		<label class="small"><spring:message code="${urlPattern}.text" text="Text"/>&nbsp;*</label>
			<form:input cssClass="sSelect" path="text"/><form:errors path="text" cssClass="validationError" />
	</p>
	<p>
		<label class="small"><spring:message code="${urlPattern}.position" text="Position"/>&nbsp;*</label>
			<form:input cssClass="integer sSelect" path="position"/><form:errors path="position" cssClass="validationError" />	
	</p>
	<p>
		<label class="small"><spring:message code="${urlPattern}.url" text="Url"/>&nbsp;*</label>
