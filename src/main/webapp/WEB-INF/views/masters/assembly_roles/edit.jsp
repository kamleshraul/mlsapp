...
<html>
<head>
	<title><spring:message code="assemblyroles.edit.title"/></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
</head>
<body>
<form:form cssClass="wufoo" action="assembly_roles" method="PUT" 
	modelAttribute="assemblyRole">
	<div class="info">
		<h2><spring:message code="assemblyroles.edit.heading"/> [Id:${assemblyRole.id}]</h2>
