...
<body>
	...
	<div class="clearfix tabbar">
		<ul class="tabs">
			...
			<c:if test="${usergroupType=='deputy_secretary' or usergroupType=='deputy_secretary1' or usergroupType=='deputy_secretary2' or usergroupType=='under_secretary' or usergroupType=='secretary'}">
				<li>
