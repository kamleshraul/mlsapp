...
<body>
	...
	<div class="commandbar">
		<div class="commandbarContent">
			<hr>
			<security:authorize access="hasAnyRole('QIS_ASSISTANT','QIS_SECTION_OFFICER','HDS_SECTION_OFFICER','QIS_DEPARTMENT_USER','ROIS_ASSISTANT','ROIS_SECTION_OFFICER','ROIS_DEPARTMENT_USER','AMOIS_SECTION_OFFICER')">
