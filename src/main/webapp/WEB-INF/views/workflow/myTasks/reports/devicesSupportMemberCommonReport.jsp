	...
	<div id="reportDiv">
      <c:choose>
			...
			<%--	 <div id="topHeader" style="text-align: center; width: 750px;">
					<h2 style="color: black;">${report[1]}</h2>
				</div>
				<br>  --%>
				<div style="font-size:20px;text-align: center;margin-right:50px">
					<b>${report[0][1]}</b>
				</div> 
				<br>
					...
					<table class="strippedTable" border="1" style="width: 750px;">
						<thead>
							<tr>
								...
								<th style="text-align: center; font-size: 12px; width: 60px;">${topHeader[0]}</th>
								<th style="text-align: center; font-size: 12px; width: 200px;">${topHeader[1]}</th>
								<th style="text-align: center; font-size: 12px; width: 340px;">${topHeader[2]}</th>
							...
							<!-- 	<th style="text-align: center; font-size: 12px; width: 90px;">${topHeader[8]}</th>  -->					
							</tr>
						<!-- 	<tr>
								<td colspan="9">&nbsp;</td>
							</tr>  -->
						...
						<tbody>
							...
							<%-- 	<c:if test="${counter.index==countingVar}">
									...
									<!-- 	<td style="text-align: center; font-size: 12px; width: 30px;">${indexNo}</td>  -->
										<%-- <td style="text-align: left; font-size: 12px; width: 60px;">${r[2]}</td> --%>
										<td style="text-align: center; font-size: 12px; width: 200px;">${indexNo}</td>
										<td style="text-align: center; font-size: 12px; width: 200px;">${r[2]}</td>
										<td style="text-align: left; font-size: 12px; width: 60px;">${r[3]}</td>
									    <td style="text-align: justify; font-size: 12px; width: 200px;">${r[4]}</td>
										<td style="text-align: left; font-size: 12px; width: 60px;">${r[5]}</td>
										<td style="text-align: center; font-size: 12px; width: 200px;">${r[6]}</td>
									    <td style="text-align: center; font-size: 12px; width: 200px;">${r[7]}</td>
									<!-- 	<td style="text-align: justify; font-size: 12px; width: 340px;">${r[5]}</td>
										...
										<td style="text-align: justify; font-size: 12px; width: 90px;">${r[9]}</td>
