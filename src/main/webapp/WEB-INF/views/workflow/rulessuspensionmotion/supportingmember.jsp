...
<head>
	...
	$(document).ready(function(){
	    ...
	    $("#viewStatus").click(function(){
		    $.get('rulessuspensionmotion/status/'+$("#rulesSuspensionMotion").val(),function(data){
			    $.fancybox.open(data);
		    }).fail(function(){
				$.unblockUI();
				if($("#ErrorMsg").val()!=''){
...
<form:form action="workflow/rulessuspensionmotion/supportingmember" method="PUT" modelAttribute="domain">
	...
	<p>
		<label class="wysiwyglabel"><spring:message code="rulessuspensionmotion.details" text="Details"/>*</label>
	...
	<input type="hidden" id="rulesSuspensionMotion" name="rulesSuspensionMotion" value="${rulesSuspensionMotion}">
</form:form>
</div>
