...
<body>
	...
	<div id="assistantDiv">
		<form:form action="workflow/rulessuspensionmotion" method="PUT" modelAttribute="domain">
			...
			<p>
				<label class="small"><spring:message code="rulessuspensionmotion.referencedmotion" text="Referenced Motion"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty referencedMotion) }">
						...
						<%-- <a href="javascript:void(0);" id="viewReferencedMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="rulessuspensionmotion.referenced.texts" text="R"></spring:message></a> --%>
