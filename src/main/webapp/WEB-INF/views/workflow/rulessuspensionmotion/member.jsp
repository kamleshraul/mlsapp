...
<head>
	...
	function loadActors(value){		
		...
		if(value!='-'){					
			var sendBack=$("#internalStatusMaster option[value='rulessuspensionmotionrecommend_sendback']").text();			
		    var discuss=$("#internalStatusMaster option[value='rulessuspensionmotionrecommend_discuss']").text();	
		    var sendToSectionOfficer=$("#internalStatusMaster option[value='rulessuspensionmotionprocessed_sendToSectionOfficer']").text();
		    var sendToDepartment=$("#internalStatusMaster option[value='rulessuspensionmotionprocessed_sendToDepartment']").text();
		    var replyReceived = $("#internalStatusMaster option[value='rulessuspensionmotionprocessed_replyReceived']").text();
		    var rejectedWithReason=$("#internalStatusMaster option[value='rulessuspensionmotionprocessed_rejectionWithReason']").text();	  
		    var clubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_clubbing']").text();
		    var clubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_reject_clubbing']").text();	
		    var nameclubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_nameclubbing']").text();
		    var nameclubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_reject_nameclubbing']").text();	    
		    var clubbingPostAdmissionRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotionrecommend_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRecommendReject = $("#internalStatusMaster option[value='rulessuspensionmotionrecommend_reject_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionApproved = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRejected = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_reject_clubbingPostAdmission']").text();
		    var unclubbingRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotionrecommend_unclubbing']").text();
		    var unclubbingRecommendReject = $("#internalStatusMaster option[value='rulessuspensionmotionrecommend_reject_unclubbing']").text();
		    var unclubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_unclubbing']").text();
		    var unclubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_reject_unclubbing']").text();
		    var admitDueToReverseClubbingRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotionrecommend_admitDueToReverseClubbing']").text();
		    var admitDueToReverseClubbing = $("#internalStatusMaster option[value='rulessuspensionmotionfinal_admitDueToReverseClubbing']").text();
	...
	<div id="assistantDiv">
		<form:form action="workflow/rulessuspensionmotion" method="PUT" modelAttribute="domain">
			...
			<p>
				...
				<label class="small"><spring:message code="rulessuspensionmotion.selectadjourningdate" text="Adjourning Date"/></label>
			...
			<p style="display:none;">
				<c:if test="${bulkedit!='yes' and domain.internalStatus.type!='rulessuspensionmotionsystem_clubbed'}">
