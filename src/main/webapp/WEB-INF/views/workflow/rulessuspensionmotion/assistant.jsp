...
<head>
	<title>
	<spring:message code="rulessuspensionmotion_${houseTypeType}" text="Rule Suspension Motion"/>
	</title>
	...
	function viewMotionDetail(id){
		...
		+"&edit=false";
		var resourceURL='rulesuspensionmotion/'+id+'/edit?'+parameters;
	...
	function loadActors(value){		
		...
		if(value!='-'){					
		    ...
		    var sendToSectionOfficer=$("#internalStatusMaster option[value='rulessuspensionmotion_processed_sendToSectionOfficer']").text();
		    var sendToDepartment=$("#internalStatusMaster option[value='rulessuspensionmotion_processed_sendToDepartment']").text();
		    var replyReceived = $("#internalStatusMaster option[value='rulessuspensionmotion_processed_replyReceived']").text();
		    var rejectedWithReason=$("#internalStatusMaster option[value='rulessuspensionmotion_processed_rejectionWithReason']").text();	  
		    var clubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotion_final_clubbing']").text();
		    var clubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotion_final_reject_clubbing']").text();	
		    var nameclubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotion_final_nameclubbing']").text();
		    var nameclubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotion_final_reject_nameclubbing']").text();	    
		    var clubbingPostAdmissionRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotion_recommend_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRecommendReject = $("#internalStatusMaster option[value='rulessuspensionmotion_recommend_reject_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionApproved = $("#internalStatusMaster option[value='rulessuspensionmotion_final_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRejected = $("#internalStatusMaster option[value='rulessuspensionmotion_final_reject_clubbingPostAdmission']").text();
		    var unclubbingRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotion_recommend_unclubbing']").text();
		    var unclubbingRecommendReject = $("#internalStatusMaster option[value='rulessuspensionmotion_recommend_reject_unclubbing']").text();
		    var unclubbingApproved = $("#internalStatusMaster option[value='rulessuspensionmotion_final_unclubbing']").text();
		    var unclubbingRejected = $("#internalStatusMaster option[value='rulessuspensionmotion_final_reject_unclubbing']").text();
		    var admitDueToReverseClubbingRecommendApprove = $("#internalStatusMaster option[value='rulessuspensionmotion_recommend_admitDueToReverseClubbing']").text();
		    var admitDueToReverseClubbing = $("#internalStatusMaster option[value='rulessuspensionmotion_final_admitDueToReverseClubbing']").text();
	...
	$(document).ready(function(){
		...
		$("#viewCitation").click(function(){
			$.get('rulesuspensionmotion/citations/'+$("#type").val()+ "?status=" + $("#internalStatus").val(),function(data){
	    ...
	    $("#viewRevision").click(function(){
	    	$.get('rulesuspensionmotion/revisions/'+$("#id").val(), function(data){
	    		$.fancybox.open(data);			    	
		    });
		    return false;
	    });
	    ...
	    $("#viewContacts").click(function(){
		    ...
		    $.get('rulesuspensionmotion/members/contacts?members='+members,function(data){
			    $.fancybox.open(data);
		    });
		    return false;
	    });
		...
		/**** To show/hide viewClubbedRulesSuspensionMotionTextsDiv to view clubbed adjournment motion's text starts****/
		...
		$("#viewClubbedRulesSuspensionMotionTextsDiv").click(function(){
			...
			if(parent!=undefined && parent!=''){			
				...
				if($("#clubbedRulesSuspensionMotionTextsDiv").css('display')=='none'){
					...
					$.get('ref/rulesuspensionmotion/'+parent+'/clubbedmotiontext',function(data){
		...
		/**** To show/hide viewClubbedRulesSuspensionMotionTextsDiv to view clubbed adjournment motion's text end****/
...
<body>
	...
	<div id="assistantDiv">
		<form:form action="workflow/rulesuspensionmotion" method="PUT" modelAttribute="domain">
			...
			<p style="display:none;">
				<label class="small"><spring:message code="rulesuspensionmotion.houseType" text="House Type"/>*</label>
			...
			<p style="display:none;">
				<label class="small"><spring:message code="rulesuspensionmotion.year" text="Year"/>*</label>
				<input id="formattedSessionYear" name="formattedSessionYear" value="${formattedSessionYear}" class="sText" readonly="readonly">
				<input id="sessionYear" name="sessionYear" value="${sessionYear}" type="hidden">
			</p>
			
			<p style="display:none;">
				<label class="small"><spring:message code="rulesuspensionmotion.sessionType" text="Session Type"/>*</label>		
			...
			<p style="display:none;">
				<label class="small"><spring:message code="rulesuspensionmotion.type" text="Type"/>*</label>
			...
			<p>
				<label class="small"><spring:message code="rulesuspensionmotion.number" text="Motion Number"/>*</label>
				<input id="formattedNumber" name="formattedNumber" value="${formattedNumber}" class="sText" readonly="readonly">		
				<input id="number" name="number" value="${domain.number}" type="hidden">
				<form:errors path="number" cssClass="validationError"/>
				
				<label class="small"><spring:message code="rulesuspensionmotion.selectadjourningdate" text="Adjourning Date"/></label>
			...
			<p>
				<label class="small"><spring:message code="rulesuspensionmotion.submissionDate" text="Submitted On"/></label>
			...
			<p>
				<label class="centerlabel"><spring:message code="rulesuspensionmotion.members" text="Members"/></label>
			...
			<p>
				<label class="small"><spring:message code="rulesuspensionmotion.primaryMemberConstituency" text="Constituency"/>*</label>
			...
			<p style="display:none;">
				...
				<a href="#" id="clubbing" onclick="clubbingInt(${domain.id});" style="margin-left: 162px;margin-right: 20px;margin-bottom: 20px;margin-top: 20px;"><spring:message code="rulesuspensionmotion.clubbing" text="Clubbing"></spring:message></a>
				<a href="#" id="refresh" onclick="refreshEdit(${domain.id});" style="margin: 20px;"><spring:message code="rulesuspensionmotion.refresh" text="Refresh"></spring:message></a>
				</c:if>	
			</p>
				
				
			<p>
				<label class="small"><spring:message code="rulesuspensionmotion.parentmotion" text="Clubbed To"></spring:message></label>
				<c:choose>
			...
			<p>
				<label class="small"><spring:message code="rulesuspensionmotion.clubbedmotions" text="Clubbed Motions"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty clubbedMotions) }">
						...
						<a href="javascript:void(0);" id="viewClubbedRulesSuspensionMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="rulesuspensionmotion.clubbed.texts" text="C"></spring:message></a>
					</c:when>
					<c:otherwise>
						<c:out value="-"></c:out>
					</c:otherwise>
			...
			<p>
				<label class="centerlabel"><spring:message code="rulesuspensionmotion.subject" text="Subject"/>*</label>
				<form:textarea path="subject" rows="2" cols="50"></form:textarea>
				<form:errors path="subject" cssClass="validationError" />	
			</p>
				
			<p>
				<label class="wysiwyglabel"><spring:message code="rulesuspensionmotion.noticeContent" text="Notice Content"/>*</label>
			...
			<p>
				<a href="#" id="reviseSubject" style="margin-left: 162px;margin-right: 20px;"><spring:message code="rulesuspensionmotion.reviseSubject" text="Revise Subject"></spring:message></a>
				<a href="#" id="reviseNoticeContent" style="margin-right: 20px;"><spring:message code="rulesuspensionmotion.reviseNoticeContent" text="Revise Notice Content"></spring:message></a>
				<a href="#" id="viewRevision"><spring:message code="rulesuspensionmotion.viewrevisions" text="View Revisions"></spring:message></a>
			</p>	
			
			<p style="display:none;" class="revise1" id="revisedSubjectDiv">
				<label class="centerlabel"><spring:message code="rulesuspensionmotion.revisedSubject" text="Revised Subject"/></label>
			...
			<p style="display:none;" class="revise2" id="revisedNoticeContentDiv">
				<label class="wysiwyglabel"><spring:message code="rulesuspensionmotion.revisedNoticeContent" text="Revised Notice Content"/></label>
			...
			<p id="internalStatusDiv">
				<label class="small"><spring:message code="rulesuspensionmotion.currentStatus" text="Current Status"/></label>
				<input id="formattedInternalStatus" name="formattedInternalStatus" value="${formattedInternalStatus }" type="text" readonly="readonly">
			</p>
			
			<p>	
				<label class="small"><spring:message code="rulesuspensionmotion.putupfor" text="Put up for"/></label>	
			...
			<p id="actorDiv" style="display: none;">
				<label class="small"><spring:message code="rulesuspensionmotion.nextactor" text="Next Users"/></label>
			...
			<p>
				<a href="#" id="viewCitation" style="margin-left: 162px;margin-top: 30px;"><spring:message code="rulesuspensionmotion.viewcitation" text="View Citations"></spring:message></a>	
			</p>
			
			<p>
			<label class="wysiwyglabel"><spring:message code="rulesuspensionmotion.remarks" text="Remarks"/></label>
	...
	<div id="clubbedRulesSuspensionMotionTextsDiv">
		<h1>		
			<spring:message code="rulesuspensionmotion.clubbedMotionTexts" text="Motion texts of clubbed motions:"></spring:message>
		</h1>
	</div>
