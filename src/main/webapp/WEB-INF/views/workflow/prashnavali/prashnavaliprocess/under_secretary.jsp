...
<head>
	...
	function addPrashnavaliInfoFunction() {
		...
		var text = "<div id='prasInfo" + questionCount + "'>" +
  		  ...
  		  "<textarea rows='5' cols='100' name='question" + questionCount + "' id='question" + questionCount + "' class='wysiwyg'></textarea>" +
  		    "</p>" +
  		 	"<p>" +
		  	"<label class='small'>" + $('#prashnavaliAnswerMessage').val() + "*</label>" +
		  	"<input name='answer" + questionCount + "' id='answer" + questionCount + "' class='wysiwyg'>" +
		  	"</p>" +
