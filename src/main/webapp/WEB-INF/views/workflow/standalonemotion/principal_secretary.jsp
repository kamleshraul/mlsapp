...
<head>
	...
	function loadActors(value){
		...
		var clarificationFromDepartment=$("#internalStatusMaster option[value='standalonemotion_final_clarificationNeededFromDepartment']").text();
		...
		var clarificationFromMember=$("#internalStatusMaster option[value='standalonemotion_final_clarificationNeededFromMember']").text();
		...
		var repeatForAdmission = $("#internalStatusMaster option[value='standalonemotion_recommend_repeatadmission']").text();
		...
		$.post(resourceURL,function(data){
			if(data!=undefined||data!=null||data!=''){
				...
				if(($('#selectedQuestionType').val()=='standalonemotion_halfhourdiscussion_standalone' 
						&& repeatForAdmission=='standalonemotion_recommend_repeatadmission' 
						&& $("#houseTypeHDS").val()=='lowerhouse') || (value == clarificationFromDepartment || value == clarificationFromMember)){
					$("#actorDiv").hide();
				}else{
					if($('#selectedQuestionType').val()=='standalonemotion_starred' && value==clarificationFromMemberAndDepartment){
						$("#actorDiv").hide();
					}else{
						$("#actorDiv").show();
					}
...
<form:form action="workflow/standalonemotion" method="PUT" modelAttribute="domain">
	...
	<c:choose>
		<c:when test="${houseTypeType=='lowerhouse1'}">
			<p>	
