	...
	<c:choose>
		<c:when test="${houseTypeType=='no1'}">
			...
			<p>
				...
				<a href="#" id="reviseQuestionText" style="margin-right: 10px;"><spring:message code="question.reviseQuestionText" text="Revise Notice Content"></spring:message></a>
		...
		<c:when test="${houseTypeType=='upperhouse' or houseTypeType=='lowerhouse'}">
			...
			<p>
				...
				<a href="#" id="reviseReason" style="margin-left: 10px;"><spring:message code="question.revise.halfhour.reason" text="Revise Reason"></spring:message></a>
				<a href="#" id="reviseBriefExplanation" style="margin: 0px 0px 10px 10px;"><spring:message code="question.reviseBriefExplanation" text="Revise Brief Explanation"></spring:message></a>	
			</p>
		</c:when>
	</c:choose>
