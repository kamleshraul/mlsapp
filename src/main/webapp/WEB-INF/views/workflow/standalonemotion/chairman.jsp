...
<head>
	...
	function loadActors(value){
		if(value!='-'){
		var dateAdmitted=$("#internalStatusMaster option[value='standalonemotion_processed_final_dateAdmitted']").text();
		var dateResubmit=$("#internalStatusMaster option[value='standalonemotion_processed_final_dateResubmit']").text();
		var nameclubbing=$("#internalStatusMaster option[value='standalonemotion_final_nameclubbing']").text();
		 var nameclubbing_reject=$("#internalStatusMaster option[value='standalonemotion_final_reject_nameclubbing']").text();
		var valueToSend = "";
	...
	function groupChanged(){
	    ...
	    var oldgroup=$("#oldgroup").val();
		    if(oldgroup!=newgroup){
			    var groupChanged=$("#internalStatusMaster option[value='standaloonemotion_system_groupchanged']").text();
