	...
	<c:choose>
		<c:when test="${houseTypeType=='lowerhouse1'}">
			...
			<p>
				...
				<a href="#" id="reviseQuestionText" style="margin-right: 20px;"><spring:message code="standalone.reviseQuestionText" text="Revise Notice Content"></spring:message></a>
			</p>
		...
		<c:when test="${houseTypeType=='upperhouse' or houseTypeType=='lowerhouse'}">
			...
			<p>
				<a href="#" id="reviseSubject" style="margin-left: 162px;margin-right: 20px;"><spring:message code="question.reviseSubject" text="Revise Subject"></spring:message></a>
				<a href="#" id="reviseReason" style="margin-right: 20px;"><spring:message code="question.revise.halfhour.reason" text="Revise Reason"></spring:message></a>
				<a href="#" id="reviseBriefExplanation" ><spring:message code="question.reviseBriefExplanation" text="Revise Brief Explanation"></spring:message></a>
			</p>
		</c:when>
	</c:choose>
