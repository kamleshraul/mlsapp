...
<head>
	...
	$(document).ready(function(){
		...
		var uHouseType = $("#houseTypeMaster option[value='"+$("#selectedHouseType").val()+"']").text();

		/* if(uHouseType =='upperhouse'){ */
...
<form:form action="workflow/standalonemotion" method="PUT" modelAttribute="domain">
	...
	<p>
		...
		<c:if test="${not (selectedQuestionType=moions_standalonemotion_halfhourdiscussion' and houseTypeType=='lowerhouse')}">
	...
	<c:if test="${selectedQuestionType=='moions_standalonemotion_halfhourdiscussion' and houseTypeType=='upperhoouse'}">
		<p style="display:none;">
		...
		<p>
		<label class="small"><spring:message code="question.clubbedquestions" text="Clubbed Standalones"></spring:message></label>
			<c:choose>
	...
	<c:if test="${selectedQuestionType=='moions_standalonemotion_halfhourdiscussion' and houseTypeType=='lowerhouse'}">
		<p>
			<label class="small"><spring:message code="question.referencedquestions" text="Referenced Questions"></spring:message></label>
			<c:choose>
				<c:when test="${!(empty referencedQuestions) }">
	...
	<p>
		...
		<%-- <c:if test="${not (selectedQuestionType=='moions_standalonemotion_halfhourdiscussion' and houseTypeType=='upperhouse') }">
		...
		<c:if test="${(selectedQuestionType=='moions_standalonemotion_halfhourdiscussion' and houseTypeType=='upperhouse')}"> --%>
...
<input type="hidden" id="uHouseType" value="${houseTypeType}" />
