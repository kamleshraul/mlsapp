...
<body>
	...
	<div id="assistantDiv">
		...
		<%-- 	<p>
			...
			<c:choose>
			<c:when test="${internalStatusType == 'specialmentionnotice_final_rejection'}">
			<p>
				<label class="wysiwyglabel"><spring:message code="specialmentionnotice.rejectionReason" text="Rejection reason"/></label>
