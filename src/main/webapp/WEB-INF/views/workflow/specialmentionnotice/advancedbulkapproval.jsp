			 ...
			 tinymce.init({
				...
				$(".viewNoticeContentTextDiv").click(function(){
				 	...
				 	if(motionIndex!=undefined && motionIndex!=''){			
						...
						if($("#noticeContentTextDiv").css('display')=='none'){
							...
							$.get('ref/specialmentionnotice/'+motionId+'/notice_content_text',function(data){
				...
				$(".viewClubbedMotionTextsDiv").click(function(){
				 	...
				 	if(parent!=undefined && parent!=''){			
						...
						if($("#clubbedMotionTextsDiv").css('display')=='none'){
							...
							$.get('ref/specialmentionnotice/'+motionId+'/clubbedmotiontext',function(data){
				...
				$(".viewReferencedMotionTextsDiv").click(function(){
					...
					if(parent!=undefined && parent!=''){			
						...
						if($("#clubbedMotionTextsDiv").css('display')=='none'){
							$("#clubbedMotionTextsDiv").empty();
							$.get('ref/specialmentionnotice/'+motionId+'/referencedmotiontext',function(data){
		...
		<div id="bulkResultDiv">	
				...
				<c:when test="${!(empty bulkapprovals) }">			
					<div style="font-size: 16px; font-weight: bold; margin-bottom: 20px;">
						...
						${bulkapprovals[0].formattedSpecialMentionNoticeDate} <spring:message code="specialmentionnotice.advancebulkapproval.header" text="Special Mention Notices"></spring:message> ${selectedWorkflowStatus})
					</div>
					<div style="overflow: scroll;">
					<form action="workflow/specialmentionnotice/advancedbulkapproval" method="POST">
						<table class="uiTable">
							<tr>					
								...
								<th style="min-width:175px;text-align:justify;vertical-align: top;"><spring:message code="specialmentionnotice.number" text="Number"></spring:message></th>
							...
							<c:forEach items="${bulkapprovals}" var="i" varStatus="j">
								...
								<tr>
									...
									<td style="text-align:justify;min-width:350px;vertical-align: top;">
										...
										<br>
										<b><spring:message code="specialmentionnotice.noticeContent" text="Notice Content" /> </b> : 
										...
										<br/><br/>
										<b><spring:message code="specialmentionnotice.clubbingTitle" /> </b> : ${i.formattedClubbedNumbers}
				...
				<c:otherwise>
					<spring:message code="specialmentionnotice.nomotions" text="No Special Mention Notice Found"></spring:message>				
				</c:otherwise>
			</c:choose>
		</div>	
