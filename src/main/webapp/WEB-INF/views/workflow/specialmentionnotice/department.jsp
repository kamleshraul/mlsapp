...
<body>
	...
	<div id="assistantDiv">
		...
		<input id="submissionMsg" value="<spring:message code='specialmentionnotice.submitForReply' text='Do you want to submit for the reply of special mention notice?'></spring:message>" type="hidden">
