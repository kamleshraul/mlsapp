...
<head>
	<title>
	<spring:message code="specialmentionnotice_${houseTypeType}" text="SpecialMentionNotice Motion"/>
	</title>
	...
	<div id="assistantDiv">
		<form:form action="workflow/specialmentionnotice" method="PUT" modelAttribute="domain">
			...
			<p>
				...
				<input id="formattedMinistry" name="formattedMinistry" type="text" readonly="readonly" class="sText" value="${formattedMinistry}">
