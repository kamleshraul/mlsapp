...
<head>
	<title>
	<spring:message code="specialmentinnotice_${houseTypeType}" text="Special Mention Notice"/>
	</title>
	...
	<div id="assistantDiv">
		<form:form action="workflow/specialmentionnotice" method="PUT" modelAttribute="domain">
			...
			<p style="display:none;">
				<label class="small"><spring:message code="specialmentinnotice.houseType" text="House Type"/>*</label>
			...
			<p style="display:none;">
				<label class="small"><spring:message code="specialmentinnotice.year" text="Year"/>*</label>
				<input id="formattedSessionYear" name="formattedSessionYear" value="${formattedSessionYear}" class="sText" readonly="readonly">
				<input id="sessionYear" name="sessionYear" value="${sessionYear}" type="hidden">
			</p>
			
			<p style="display:none;">
				<label class="small"><spring:message code="specialmentinnotice.sessionType" text="Session Type"/>*</label>		
			...
			<p style="display:none;">
				<label class="small"><spring:message code="specialmentinnotice.type" text="Type"/>*</label>
			...
			<p>
				<label class="small"><spring:message code="specialmentinnotice.number" text="Motion Number"/>*</label>
				<input id="formattedNumber" name="formattedNumber" value="${formattedNumber}" class="sText" readonly="readonly">		
				<input id="number" name="number" value="${domain.number}" type="hidden">
				<form:errors path="number" cssClass="validationError"/>
				
				<label class="small"><spring:message code="specialmentinnotice.selectspecialmentionnoticedate" text="SpecialMentionNotice Date"/></label>
				...
				<a href="#" id="changeSpecialMentionNoticeDate" style="margin-left: 10px;"><spring:message code="specialmentinnotice.changeSpecialMentionNoticeDate" text="Change SpecialMentionNotice Date"/></a> --%>
			...
			<p>
				<label class="small"><spring:message code="specialmentinnotice.submissionDate" text="Submitted On"/></label>
			...
			<p>
				<label class="small"><spring:message code="specialmentinnotice.ministry" text="Ministry"/></label>
				...
				<label class="small"><spring:message code="specialmentinnotice.subdepartment" text="Sub Department"/></label>
			...
			<p>
				<label class="centerlabel"><spring:message code="specialmentinnotice.members" text="Members"/></label>
			...
			<p>
				<label class="small"><spring:message code="specialmentinnotice.primaryMemberConstituency" text="Constituency"/>*</label>
			...
			<p style="display:none;">
				<c:if test="${bulkedit!='yes' and domain.internalStatus.type!='specialmentinnotice_system_clubbed'}">
			
				<a href="#" id="clubbing" onclick="clubbingInt(${domain.id});" style="margin-left: 162px;margin-right: 20px;margin-bottom: 20px;margin-top: 20px;"><spring:message code="specialmentinnotice.clubbing" text="Clubbing"></spring:message></a>
				<a href="#" id="referencing" onclick="referencingInt(${domain.id});" style="margin: 20px;"><spring:message code="specialmentinnotice.referencing" text="Referencing"></spring:message></a>
				<a href="#" id="refresh" onclick="refreshEdit(${domain.id});" style="margin: 20px;"><spring:message code="specialmentinnotice.refresh" text="Refresh"></spring:message></a>
				</c:if>	
			</p>
			
			
			<p>
				<label class="small"><spring:message code="specialmentinnotice.parentmotion" text="Clubbed To"></spring:message></label>
				<c:choose>
			...
			<p>
				<label class="small"><spring:message code="specialmentinnotice.clubbedmotions" text="Clubbed Motions"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty clubbedMotions) }">
						...
						<a href="javascript:void(0);" id="viewClubbedSpecialMentionNoticeDateTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="specialmentinnotice.clubbed.texts" text="C"></spring:message></a>
					</c:when>
					<c:otherwise>
						<c:out value="-"></c:out>
					</c:otherwise>
		...
		<%-- 	<p>
				<label class="small"><spring:message code="specialmentinnotice.referencedmotion" text="Referenced Motion"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty referencedMotion) }">
						...
						<a href="javascript:void(0);" id="viewReferencedMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="specialmentinnotice.referenced.texts" text="R"></spring:message></a>
						<input type="hidden" id="referencedSpecialMentionNoticeDateMotion" name="parent" value="${referencedMotion.id}">
					</c:when>
					<c:otherwise>
						<c:out value="-"></c:out>
					</c:otherwise>
			...
			<p>
				<label class="centerlabel"><spring:message code="specialmentinnotice.subject" text="Subject"/>*</label>
				<form:textarea path="subject" rows="2" cols="50"></form:textarea>
				<form:errors path="subject" cssClass="validationError" />	
			</p>
				
			<p>
				<label class="wysiwyglabel"><spring:message code="specialmentinnotice.noticeContent" text="Notice Content"/>*</label>
			...
			<p>
				<a href="#" id="reviseSubject" style="margin-left: 162px;margin-right: 20px;"><spring:message code="specialmentinnotice.reviseSubject" text="Revise Subject"></spring:message></a>
				<a href="#" id="reviseNoticeContent" style="margin-right: 20px;"><spring:message code="specialmentinnotice.reviseNoticeContent" text="Revise Notice Content"></spring:message></a>
				<a href="#" id="viewRevision"><spring:message code="specialmentinnotice.viewrevisions" text="View Revisions"></spring:message></a>
			</p>	
			
			<p style="display:none;" class="revise1" id="revisedSubjectDiv">
				<label class="centerlabel"><spring:message code="specialmentinnotice.revisedSubject" text="Revised Subject"/></label>
			...
			<p style="display:none;" class="revise2" id="revisedNoticeContentDiv">
				<label class="wysiwyglabel"><spring:message code="specialmentinnotice.revisedNoticeContent" text="Revised Notice Content"/></label>
			...
			<p id="internalStatusDiv">
				<label class="small"><spring:message code="specialmentinnotice.currentStatus" text="Current Status"/></label>
				<input id="formattedInternalStatus" name="formattedInternalStatus" value="${formattedInternalStatus }" type="text" readonly="readonly">
			</p>
			
			<p>	
				<label class="small"><spring:message code="specialmentinnotice.putupfor" text="Put up for"/></label>	
			...
			<p id="actorDiv" style="display: none;">
				<label class="small"><spring:message code="specialmentinnotice.nextactor" text="Next Users"/></label>
			...
			<p>
				<a href="#" id="viewCitation" style="margin-left: 162px;margin-top: 30px;"><spring:message code="specialmentinnotice.viewcitation" text="View Citations"></spring:message></a>	
			</p>
			
			<p>
			<label class="wysiwyglabel"><spring:message code="specialmentinnotice.remarks" text="Remarks"/></label>
...
<%-- 	<!--To show the motion texts of the clubbed motions -->
	<div id="clubbedSpecialMentionNoticeDateTextsDiv">
		<h1>		
			<spring:message code="specialmentinnotice.clubbedMotionTexts" text="Motion texts of clubbed motions:"></spring:message>
		</h1>
	</div> --%>
