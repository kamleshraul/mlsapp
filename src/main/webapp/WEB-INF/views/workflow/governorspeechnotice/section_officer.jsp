...
<head>
	<title>
	<spring:message code="governorspeechnotice_${houseTypeType}" text="Governor Speech Notice"/>
	</title>
	...
	function viewMotionDetail(id){
		...
		+"&edit=false";
		var resourceURL='governorspeechnotice/'+id+'/edit?'+parameters;
	...
	function loadActors(value){		
		...
		if(value!='-'){					
			var sendBack=$("#internalStatusMaster option[value='governorspeechnotice_recommend_sendback']").text();			
		    var discuss=$("#internalStatusMaster option[value='governorspeechnotice_recommend_discuss']").text();	
		    var sendToSectionOfficer=$("#internalStatusMaster option[value='governorspeechnotice_processed_sendToSectionOfficer']").text();
		    var sendToDepartment=$("#internalStatusMaster option[value='governorspeechnotice_processed_sendToDepartment']").text();
		    var replyReceived = $("#internalStatusMaster option[value='governorspeechnotice_processed_replyReceived']").text();
		    var rejectedWithReason=$("#internalStatusMaster option[value='governorspeechnotice_processed_rejectionWithReason']").text();	  
		    var clubbingApproved = $("#internalStatusMaster option[value='governorspeechnotice_final_clubbing']").text();
		    var clubbingRejected = $("#internalStatusMaster option[value='governorspeechnotice_final_reject_clubbing']").text();	
		    var nameclubbingApproved = $("#internalStatusMaster option[value='governorspeechnotice_final_nameclubbing']").text();
		    var nameclubbingRejected = $("#internalStatusMaster option[value='governorspeechnotice_final_reject_nameclubbing']").text();	    
		    var clubbingPostAdmissionRecommendApprove = $("#internalStatusMaster option[value='governorspeechnotice_recommend_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRecommendReject = $("#internalStatusMaster option[value='governorspeechnotice_recommend_reject_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionApproved = $("#internalStatusMaster option[value='governorspeechnotice_final_clubbingPostAdmission']").text();
		    var clubbingPostAdmissionRejected = $("#internalStatusMaster option[value='governorspeechnotice_final_reject_clubbingPostAdmission']").text();
		    var unclubbingRecommendApprove = $("#internalStatusMaster option[value='governorspeechnotice_recommend_unclubbing']").text();
		    var unclubbingRecommendReject = $("#internalStatusMaster option[value='governorspeechnotice_recommend_reject_unclubbing']").text();
		    var unclubbingApproved = $("#internalStatusMaster option[value='governorspeechnotice_final_unclubbing']").text();
		    var unclubbingRejected = $("#internalStatusMaster option[value='governorspeechnotice_final_reject_unclubbing']").text();
		    var admitDueToReverseClubbingRecommendApprove = $("#internalStatusMaster option[value='governorspeechnotice_recommend_admitDueToReverseClubbing']").text();
		    var admitDueToReverseClubbing = $("#internalStatusMaster option[value='governorspeechnotice_final_admitDueToReverseClubbing']").text();
			...
			var resourceURL = 'ref/governorspeechnotice/actors?' + params;
	...
	$(document).ready(function(){
		...
		$("#viewCitation").click(function(){
			$.get('governorspeechnotice/citations/'+$("#type").val()+ "?status=" + $("#internalStatus").val(),function(data){
	    ...
	    $("#viewRevision").click(function(){
	    	$.get('governorspeechnotice/revisions/'+$("#id").val(), function(data){
	    		$.fancybox.open(data);			    	
		    });
		    return false;
	    });
	    ...
	    $("#viewContacts").click(function(){
		    ...
		    $.get('governorspeechnotice/members/contacts?members='+members,function(data){
			    $.fancybox.open(data);
		    });
		    return false;
	    });
		...
		/**** To show/hide viewClubbedSpecialMentionNoticeTextsDiv to view clubbed special mention notice's text starts****/
		...
		$("#viewClubbedSpecialMentionNoticeTextsDiv").click(function(){
			...
			if(parent!=undefined && parent!=''){			
				...
				if($("#clubbedSpecialMentionNoticeTextsDiv").css('display')=='none'){
					...
					$.get('ref/governorspeechnotice/'+parent+'/clubbedmotiontext',function(data){
		...
		/**** To show/hide viewClubbedSpecialMentionNoticeTextsDiv to view clubbed special mention notice's text end****/
...
<body>
	...
	<div id="assistantDiv">
		<form:form action="workflow/governorspeechnotice" method="PUT" modelAttribute="domain">
			...
			<p style="display:none;">
				<label class="small"><spring:message code="governorspeechnotice.houseType" text="House Type"/>*</label>
			...
			<p style="display:none;">
				<label class="small"><spring:message code="governorspeechnotice.year" text="Year"/>*</label>
				<input id="formattedSessionYear" name="formattedSessionYear" value="${formattedSessionYear}" class="sText" readonly="readonly">
				<input id="sessionYear" name="sessionYear" value="${sessionYear}" type="hidden">
			</p>
			
			<p style="display:none;">
				<label class="small"><spring:message code="governorspeechnotice.sessionType" text="Session Type"/>*</label>		
			...
			<p style="display:none;">
				<label class="small"><spring:message code="governorspeechnotice.type" text="Type"/>*</label>
			...
			<p>
				<label class="small"><spring:message code="governorspeechnotice.number" text="Motion Number"/>*</label>
				<input id="formattedNumber" name="formattedNumber" value="${formattedNumber}" class="sText" readonly="readonly">		
				<input id="number" name="number" value="${domain.number}" type="hidden">
				<form:errors path="number" cssClass="validationError"/>
				
				<%-- <label class="small"><spring:message code="governorspeechnotice.selectspecialMentionNoticedate" text="governorspeechnotice Date"/></label> --%>
				...
				<a href="#" id="changeSpecialMentionNoticeDate" style="margin-left: 10px;"><spring:message code="governorspeechnotice.changeSpecialMentionNoticeDate" text="Change governorspeechnotice Date"/></a> --%>
			...
			<p>
				<label class="small"><spring:message code="governorspeechnotice.submissionDate" text="Submitted On"/></label>
			...
			<%-- <p>
				<label class="small"><spring:message code="governorspeechnotice.ministry" text="Ministry"/></label>
				<input id="formattedMinistry" name="formattedMinistry" type="text" class="sText" value="${formattedMinistry}">
				<input name="ministry" id="ministry" type="hidden" readonly="readonly" value="${ministrySelected}"> --%>
				...
				<label class="small"><spring:message code="governorspeechnotice.subdepartment" text="Sub Department"/></label>
				<select name="subDepartment" id="subDepartment" class="sSelect" readonly="readonly">
			...
			<p>
				<label class="centerlabel"><spring:message code="governorspeechnotice.members" text="Members"/></label>
			...
			<p>
				<label class="small"><spring:message code="governorspeechnotice.primaryMemberConstituency" text="Constituency"/>*</label>
			...
			<p style="display:none;">
				<c:if test="${bulkedit!='yes' and domain.internalStatus.type!='governorspeechnotice_system_clubbed'}">
			
				<a href="#" id="clubbing" onclick="clubbingInt(${domain.id});" style="margin-left: 162px;margin-right: 20px;margin-bottom: 20px;margin-top: 20px;"><spring:message code="governorspeechnotice.clubbing" text="Clubbing"></spring:message></a>
				<a href="#" id="referencing" onclick="referencingInt(${domain.id});" style="margin: 20px;"><spring:message code="governorspeechnotice.referencing" text="Referencing"></spring:message></a>
				<a href="#" id="refresh" onclick="refreshEdit(${domain.id});" style="margin: 20px;"><spring:message code="governorspeechnotice.refresh" text="Refresh"></spring:message></a>
				</c:if>	
			</p>
			
			
			<%-- <p>
				<label class="small"><spring:message code="governorspeechnotice.parentmotion" text="Clubbed To"></spring:message></label>
				<c:choose>
			...
			<%-- <p>
				<label class="small"><spring:message code="governorspeechnotice.clubbedmotions" text="Clubbed Motions"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty clubbedMotions) }">
						...
						<a href="javascript:void(0);" id="viewClubbedSpecialMentionNoticeTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="governorspeechnotice.clubbed.texts" text="C"></spring:message></a>
					</c:when>
					<c:otherwise>
						<c:out value="-"></c:out>
					</c:otherwise>
		...
		<%-- 	<p>
				<label class="small"><spring:message code="governorspeechnotice.referencedmotion" text="Referenced Motion"></spring:message></label>
				<c:choose>
					<c:when test="${!(empty referencedMotion) }">
						...
						<a href="javascript:void(0);" id="viewReferencedMotionTextsDiv" style="border: 1px solid #000000; background-color: #657A8F; border-radius: 5px; color: #FFFFFF; text-decoration: none;"><spring:message code="governorspeechnotice.referenced.texts" text="R"></spring:message></a>
			...
			<p>
				<a href="#" id="reviseSubject" style="margin-left: 162px;margin-right: 20px;"><spring:message code="governorspeechnotice.reviseSubject" text="Revise Subject"></spring:message></a>
				<a href="#" id="reviseNoticeContent" style="margin-right: 20px;"><spring:message code="governorspeechnotice.reviseNoticeContent" text="Revise Notice Content"></spring:message></a>
				<a href="#" id="viewRevision"><spring:message code="governorspeechnotice.viewrevisions" text="View Revisions"></spring:message></a>
			</p>	
			
			<p style="" class="revise1" id="revisedSubjectDiv">
				<label class="centerlabel"><spring:message code="governorspeechnotice.revisedSubject" text="Revised Subject"/></label>
			...
			<p style="" class="revise2" id="revisedNoticeContentDiv">
				<label class="wysiwyglabel"><spring:message code="governorspeechnotice.revisedNoticeContent" text="Revised Notice Content"/></label>
			...
			<p>	
				<label class="small"><spring:message code="governorspeechnotice.putupfor" text="Put up for"/></label>	
			...
			<p id="actorDiv" style="display: none;">
				<label class="small"><spring:message code="governorspeechnotice.nextactor" text="Next Users"/></label>
			...
			<%-- <c:choose>
				<c:when test="${internalStatusType == 'specialmentionnotice_final_admission'}">
					<p>
					<label class="small"><spring:message code="governorspeechnotice.lastDateOfReplyReceiving" text="Last date of receiving reply"/></label>
			...
			<%-- <c:choose>
				<c:when test="${internalStatusType == 'governorspeechnotice_final_admission'}">
					<p>
						<label class="small"><spring:message code="governorspeechnotice.replyRequestedDate" text="Reply Requested Date"/></label>
					...
					<p>
						<label class="small"><spring:message code="governorspeechnotice.replyReceivedDate" text="Reply Received Date"/></label>
			...
			<%-- <p>
				<a href="#" id="viewCitation" style="margin-left: 162px;margin-top: 30px;"><spring:message code="governorspeechnotice.viewcitation" text="View Citations"></spring:message></a>	
			</p> --%>
			
			<p>
			<label class="wysiwyglabel"><spring:message code="governorspeechnotice.remarks" text="Remarks"/></label>
			<form:textarea path="remarks" cssClass="wysiwyg"></form:textarea>
			<%-- <form:hidden path="remarksAboutDecision"/> --%>
			</p>	
			
			<c:choose>
			<c:when test="${internalStatusType == 'governorspeechnotice_final_rejection'}">
			<p>
				<label class="wysiwyglabel"><spring:message code="governorspeechnotice.rejectionReason" text="Rejection reason"/></label>
			...
			<p>
				<label class="wysiwyglabel"><spring:message code="governorspeechnotice.reply" text="Reply"/></label>
			...
			<p>
				<label class="wysiwyglabel"><spring:message code="governorspeechnotice.reasonForLateReply" text="Reason for Late Reply"/></label>
	...
	<div id="clubbedSpecialMentionNoticeTextsDiv">
		<h1>		
			<spring:message code="governorspeechnotice.clubbedMotionTexts" text="Motion texts of clubbed motions:"></spring:message>
		</h1>
	</div>
