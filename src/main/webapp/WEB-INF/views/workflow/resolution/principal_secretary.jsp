...
<head>
	...
	function loadActors(value){
		...
		var clarificationFromDepartment=$("#internalStatusMaster option[value='resolution_final_clarificationNeededFromDepartment']").text();
		var clarificationFromMember=$("#internalStatusMaster option[value='resolution_final_clarificationNeededFromMember']").text();
		valueToSend = value;
		var params='';
		...
		$.post(resourceURL,function(data){
			if(data!=undefined||data!=null||data!=''){
				...
				if(value == clarificationFromDepartment || value == clarificationFromMember){
					$("#actorDiv").hide();
				}else{
					$("#actorDiv").show();
				}
