		...
		function loadActors(value){
			...
			$.post(resourceURL,function(data){				
				if(data!=undefined&&data!=null&&data!=''&&data.length!=0){
					...
					$("#actorDiv").show();				
					if(value!=sendback&&value!=discuss&&value!=translate&&value!=opinion_from_lawandjd&&value!=sendToSectionOfficer){
					...
					$("#actorForWorkflow").empty();
					$("#actorDiv").hide();
					if(value!=sendback&&value!=discuss&&value!=translate&&value!=reject_translate&&value!=opinion_from_lawandjd&&value!=sendToSectionOfficer){
						$("#internalStatus").val(value);
					} 
					if(value==translate) {
						$("#translationStatus").val(value);						
		...
		<div class="fields clearfix watermark">		
			<div id="assistantDiv">
				<form:form action="workflow/bill" method="PUT" modelAttribute="domain">
					...
					<div>
						<fieldset>
							<legend style="text-align: left; width: 150px;"><label><spring:message code="bill.financialMemorandumDrafts" text="Financial Memorandum Drafts" /></label></legend>
							<a href="#" class="viewRevisions" id="viewRevisions_financialMemorandumDrafts_${i.language.type}" style="margin-left: 162px;margin-right: 20px;"><spring:message code="bill.viewRevisionsForFinancialMemorandumDrafts" text="View Revisions for Financial Memorandum Drafts"></spring:message></a>
					...
					<div>
						<fieldset>
							<legend style="text-align: left; width: 150px;"><label><spring:message code="bill.statutoryMemorandumDrafts" text="Statutory Memorandum Drafts" /></label></legend>
							<a href="#" class="viewRevisions" id="viewRevisions_statutoryMemorandumDrafts_${i.language.type}" style="margin-left: 162px;margin-right: 20px;"><spring:message code="bill.viewRevisionsForStatutoryMemorandumDrafts" text="View Revisions for Statutory Memorandum Drafts"></spring:message></a>
