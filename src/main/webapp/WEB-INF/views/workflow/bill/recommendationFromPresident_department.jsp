...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			$("#currentForm :input[type=text]").not("#recommendationFromPresident,#remarks,#save,#submit").attr("readonly", true);
			$("#currentForm :input[type!=text]").not("#recommendationFromPresident,#remarks,#save,#submit").attr("disabled", true);
