					...
					<p>
						...
						<div class="textdraft_file" id="opinionSoughtFromLawAndJD_FileDiv">
							<jsp:include page="/common/file_load.jsp">
								...
								<jsp:param name="isRemovable" value="${isOpinionFromLawAndJDReadonly=='false'? 'true' : 'false'}" />
								<jsp:param name="isUploadAllowed" value="${isOpinionFromLawAndJDReadonly=='false'? 'true' : 'false'}" />
							</jsp:include>							
						</div>
