...
<head>
	...
	$(document).ready(function(){
	    ...
	    $("#sendback").click(function(e){
			...
			console.log($("#dateOfAnsweringByMinister").val());
...
<form:form action="workflow/question/mytask" method="PUT" modelAttribute="domain">
	...
	<select id="sendbackactor" name="sendbackactor" class="sSelect">
	...
	<input id="dateOfAnsweringByMinister" name="dateOfAnsweringByMinister" class="datemask sText" type="text">
	</p>
	</c:if>
	...
	<div class="fields">
		<h2></h2>
		<p class="tright">
		<input id="sendback" type="button" value="<spring:message code='generic.sendback' text='Send Answer'/>" class="butDef">
		</p>
	</div>
	<form:hidden path="id"/>
	...
	<input id="flag" name="flag" type="hidden" value="question_after_approval_department_sent_answer">
	<%--21012013 --%>
