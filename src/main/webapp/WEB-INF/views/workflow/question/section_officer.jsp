...
<head>
	...
	function loadActors(value){
		...
		var sendToMember=$("#internalStatusMaster option[value='question_processed_sendToMember']").text();
		...
		$.post(resourceURL,function(data){
			if(data!=undefined||data!=null||data!=''){
				...
				$("#actor").html(text);
				if((questionType == 'questions_shortnotice' && value == dateAndAnswerReceived) || questionType == 'questions_halfhourdiscussion_standalone') {
					$("#actorDiv").show();
				}
				else {
					$("#actorDiv").hide();
