...
<form:form action="workflow/question" method="PUT" modelAttribute="domain">
	...
	<c:if test="${not (selectedQuestionType=='questions_halfhourdiscussion_standalone' and houseType=='upperhouse')}">	
		<p>
	...
	<c:if test="${selectedQuestionType=='questions_shortnotice' or selectedQuestionType=='questions_halfhourdiscussion_from_question' or (selectedQuestionType=='questions_halfhourdiscussion_standalone' and houseType=='upperhouse')}">
	<p>
		<c:choose>
	...
	<c:if test="${selectedQuestionType=='questions_halfhourdiscussion_from_question' or (selectedQuestionType=='questions_halfhourdiscussion_standalone' and houseType=='upperhouse')}">
		<p>
