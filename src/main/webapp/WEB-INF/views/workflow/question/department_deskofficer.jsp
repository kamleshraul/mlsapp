		...
		if(value!='-'){	
			...
			if(data!=undefined||data!=null||data!=''){
				...
				if(value != sendback && value != discuss 
						&& value !=sendToSectionOfficer && value !=sendToDeskOfficer){
...
<form:form action="workflow/question" method="PUT" modelAttribute="domain">
	...
	<%-- <p>
		<label class="small"><spring:message code="question.mlsBranchNotified" text="Is the Respective Question Branch Notified"/></label>
		<input type="checkbox" id="mlsBranchNotified" name="mlsBranchNotified"/>
	</p> --%>
	<p>
	...
	<c:if test="${(workflowstatus!='COMPLETED' and (internalStatusType == 'question_final_admission' or internalStatusType =='question_unstarred_final_admission' 
												...
												or internalStatusType =='question_shortnotice_final_clarificationNeededFromDepartment'
