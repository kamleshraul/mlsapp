...
<form:form action="workflow/question/secretary" method="PUT" modelAttribute="domain">
	...
	<a href="#" id="copySubject" style="display:none;"><spring:message code="question.copysubject" text="Copy original subject"></spring:message></a>	
	</p>
	...
	<a href="#" id="copyQuestionText" style="display:none;"><spring:message code="question.viewcitation" text="Copy original question"></spring:message></a>	
	</p>
