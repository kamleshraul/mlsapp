...
<head>
	...
	function loadActors(value){
		...
		var sendback = "";
		var discuss = "";
		var clarificationFromDepartment = "";
		var clarificationFromMemberAndDepartment = "";
		var clarificationFromMember = "";
		var admitDate = "";
		var resubmitDate = "";
		...
		if(deviceTypeType == 'questions_starred') {
			...
			clarificationFromDepartment = $("#internalStatusMaster option[value='question_final_clarificationNeededFromDepartment']").text();
			clarificationFromMemberAndDepartment = $("#internalStatusMaster option[value='question_recommend_clarificationNeededFromMemberAndDepartment']").text();
			clarificationFromMember = $("#internalStatusMaster option[value='question_final_clarificationNeededFromMember']").text();
			...
			clarificationFromDepartment = $("#internalStatusMaster option[value='question_unstarred_final_clarificationNeededFromDepartment']").text();
			clarificationFromMemberAndDepartment = $("#internalStatusMaster option[value='question_unstarred_recommend_clarificationNeededFromMemberAndDepartment']").text();
			clarificationFromMember = $("#internalStatusMaster option[value='question_unstarred_final_clarificationNeededFromMember']").text();
			...
			clarificationFromDepartment = $("#internalStatusMaster option[value='question_shortnotice_final_clarificationNeededFromDepartment']").text();
			clarificationFromMemberAndDepartment = $("#internalStatusMaster option[value='question_shortnotice_recommend_clarificationNeededFromMemberAndDepartment']").text();
			clarificationFromMember = $("#internalStatusMaster option[value='question_shortnotice_final_clarificationNeededFromMember']").text();
			...
			clarificationFromDepartment = $("#internalStatusMaster option[value='question_halfHourFromQuestion_final_clarificationNeededFromDepartment']").text();
			...
			clarificationFromMember = $("#internalStatusMaster option[value='question_halfHourFromQuestion_final_clarificationNeededFromMember']").text();
		...
		$.post(resourceURL,function(data){
			if(data!=undefined||data!=null||data!=''){
				...
				if(($('#selectedQuestionType').val()=='questions_halfhourdiscussion_standalone' 
						&& repeatForAdmission=='question_recommend_repeatadmission' 
...
<input type="hidden" id="houseTypeHDS" value="${domain.houseType.type}" />
