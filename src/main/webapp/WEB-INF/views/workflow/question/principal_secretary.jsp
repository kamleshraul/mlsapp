...
<head>
	...
	function loadActors(value){
		...
		var repeatForAdmission = $("#internalStatusMaster option[value='question_recommend_repeatadmission']").text();
...
<form:form action="workflow/question" method="PUT" modelAttribute="domain">
	...
	<c:if test="${not (selectedQuestionType=='questions_halfhourdiscussion_standalone' && houseTypeType=='lowerhouse')}">
	<p style="display:none;">
		...
		<c:if test="${selectedQuestionType=='questions_halfhourdiscussion_from_question' or (selectedQuestionType=='questions_halfhourdiscussion_standalone' and houseTypeType=='upperhouse')}">
			<c:choose>
				<c:when test="${(selectedQuestionType=='questions_halfhourdiscussion_standalone' and houseTypeType=='upperhouse')}">
					<a href="#" id="reviseReason" style="margin-left: 20px; margin-right: 20px;"><spring:message code="question.reviseReason" text="Revise Reason"></spring:message></a>
				</c:when>
				<c:otherwise>
					<a href="#" id="reviseReason" style="margin-left: 162px;"><spring:message code="question.reviseReason" text="Revise Reason"></spring:message></a>
				</c:otherwise>
			</c:choose>
