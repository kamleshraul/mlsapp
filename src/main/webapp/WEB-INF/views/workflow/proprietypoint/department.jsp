	...
	<div id="assistantDiv">
		<form:form action="workflow/proprietypoint" method="PUT" modelAttribute="domain">
			...
			<p>
				...
				<label class="small"><spring:message code="proprietypoint.selectadjourningdate" text="Adjourning Date"/></label>
				...
				<a href="#" id="changeAdjourningDate" style="margin-left: 10px;"><spring:message code="proprietypoint.changeAdjourningDate" text="Change Adjourning Date"/></a> --%>
			...
			<div class="fields">
				...
				<%-- <c:if test="${currTimeMillis <= sendbacktimelimit}"> --%>
					<input id="sendBack" type="button" value="<spring:message code='proprietypoint.sendback' text='Send Back'/>" class="butDef">
				<%-- </c:if> --%>
