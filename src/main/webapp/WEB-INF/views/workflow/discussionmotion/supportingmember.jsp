...
<head>
	...
	$(document).ready(function(){
	    ...
	    $("#viewStatus").click(function(){
		    $.get('discussionmotion/status/'+$("#discussionmotion").val(),function(data){
			    $.fancybox.open(data);
		    }).fail(function(){
    			if($("#ErrorMsg").val()!=''){
...
<form:form action="workflow/discussionmotion/supportingmember" method="PUT" modelAttribute="domain">
	...
	<p>
		<label class="wysiwyglabel"><spring:message code="discussionmotion.noticeContent" text="Content"/>*</label>
	...
	<p>
	<label class="small"><spring:message code="discussionmotion.decisionstatus" text="Decision?"/>*</label>
	...
	<input type="hidden" id="discussionmotion" name="discussionmotion" value="${discussionMotion}">
