	...
	$(document).ready(function(){
		...
		$("#reviseNoticeContent").click(function(){
			...
			if($("#revisedNoticeContentDiv").css("display")=="none"){
				$("#reviseNoticeContent").wysiwyg("setContent","");
			}else{
				$("#reviseNoticeContent").wysiwyg("setContent",$("#noticeContent").val());				
			}				
			return false;			
		});			
		/**** Revisions ****/
...
<form:form action="workflow/discussionmotion" method="PUT" modelAttribute="domain">
	...
	<p>
		<label class="small"><spring:message code="discussionmotion.number" text="Motion Nmber"/>*</label>
	...
	<select name="ministries" id="ministries" multiple="multiple" size="5" style="width:200px;" readonly="readonly">
	...
	<select name="subDepartments" id="subDepartments" multiple="multiple" size="5" readonly="readonly">
...
<input id="motionType" type="hidden" value="${selectedDiscussionMotionType}" />
