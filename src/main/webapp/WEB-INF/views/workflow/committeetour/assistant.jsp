...
<form:form action="workflow/committeetour" method="PUT" modelAttribute="domain">
	...
	<c:choose>
		<c:when test="${not empty committeeNames}">
	...
	<c:choose>
		...
		<c:otherwise>
			<option value="${state.id}" selected="selected"><c:out value="${state.name}"></c:out></option>
		</c:otherwise>
	</c:choose>
	</select>
	</p>
	...
	<c:choose>
		...
		<c:otherwise>
			<option value="${district.id}" selected="selected"><c:out value="${district.name}"></c:out></option>
		</c:otherwise>
	</c:choose>
	</select>
	</p>
