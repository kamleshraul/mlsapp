...
<form:form  action="questiontype" method="PUT" modelAttribute="domain">
	...
	<p class="onQuestionLimit">
		<label class="small"><spring:message code="questiontype.questionLimitingAction" text="District" /></label>			
