...
<head>
	<title>
	<spring:message code="specialmentionnotice.member_specialmentionnotices_view" text="Member's Special Mention Notices View"/>
	</title>
...
<body>
	...
	<div id="reportDiv">
		<c:choose>
			...
			<c:otherwise>
				<spring:message code="member_specialmentionnotices_view.nodatafound" text="No Data Found"/>
			</c:otherwise>
		</c:choose>
	</div>
</body>
