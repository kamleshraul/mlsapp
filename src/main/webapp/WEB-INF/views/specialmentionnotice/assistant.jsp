...
<head>
	...
	function loadActors(value){
	    ...
	    var clubbingPostAdmission = $("#internalStatusMaster option[value='specialmentionnotice_recommend_clubbingPostAdmission']").text();
		var unclubbing = $("#internalStatusMaster option[value='specialmentionnotice_recommend_unclubbing']").text();
		var admitDueToReverseClubbing = $("#internalStatusMaster option[value='specialmentionnotice_recommend_admitDueToReverseClubbing']").text();
	...
	$(document).ready(function(){
		...
		$(".clubbedRefMotions").contextMenu({
			...
			if(action=='unclubbing'){
				...
				$.post('refentity/specialmentionnotice/dereferencing?pId='+motionId+"&rId="+refId,function(data){
					if(data=='SUCCESS'){
...
<body>
	...
	<div id="assistantDiv">
		<form:form action="specialmentionnotice" method="PUT" modelAttribute="domain">
			...
			<c:if test="${internalStatusType == 'specialmentionnotice_system_assistantprocessed' || internalStatusType == 'specialmentionnotice_putup_rejection'
				|| internalStatusType == 'specialmentionnotice_putup_clubbing' || internalStatusType == 'specialmentionnotice_putup_nameclubbing' 
				|| recommendationStatusType == 'specialmentionnotice_putup_clubbingPostAdmission' || recommendationStatusType == 'specialmentionnotice_putup_clubbingWithUnstarredFromPreviousSession'
				|| recommendationStatusType == 'specialmentionnotice_putup_unclubbing' || recommendationStatusType == 'specialmentionnotice_putup_admitDueToReverseClubbing'
			}">
			...
			<c:if test="${fn:contains(internalStatusType, 'specialmentionnotice_final')}">
			...
			<div class="fields">
				...
				<p class="tright">
					<c:choose>
						<c:when test="${(internalStatusType eq'specialmentionnotice_final_admission' || internalStatusType eq 'specialmentionnotice_final_rejection') && empty parent}">
							<input id="submit" type="submit" value="<spring:message code='generic.submit' text='Submit'/>" class="butDef">
						</c:when>
						<c:when test="${bulkedit!='yes'}">
							<c:if test="${internalStatusType=='specialmentionnotice_submit' || internalStatusType=='specialmentionnotice_system_assistantprocessed' || internalStatusType=='specialmentionnotice_system_putup'
								|| internalStatusType=='specialmentionnotice_putup_rejection' || internalStatusType == 'specialmentionnotice_putup_clubbing' || internalStatusType == 'specialmentionnotice_putup_nameclubbing' 
								|| recommendationStatusType == 'specialmentionnotice_putup_clubbingPostAdmission' || recommendationStatusType == 'specialmentionnotice_putup_unclubbing' 
