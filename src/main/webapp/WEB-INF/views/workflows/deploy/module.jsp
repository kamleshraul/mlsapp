...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			showTabByIdAndUrl('list_tab','wf/deploy/list');
		});	
		function showList() {
			showTabByIdAndUrl('list_tab','wf/deploy/list');
		}	
		...
		function newRecord() {
			showTabByIdAndUrl('details_tab','wf/deploy/new')	;
		}
		...
		function deleteRecord(row) {
			if(row == null || row == ''){
				...
				$.prompt($('#confirmDeleteMessage').val()+ row,{
			        ...
			        if(v){
				        $.delete_('wf/deploy/'+row+'/delete', null, function(data, textStatus, XMLHttpRequest) {
				            showList();
				        });
			        }
				}});
