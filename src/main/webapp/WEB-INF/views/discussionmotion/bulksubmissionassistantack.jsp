...
<html>
<head>
	<title><spring:message code="discussionmotion.bulksubmission" text="Bulk Submissions" /></title>
...
<body>	
	...
	<table class="uiTable">
		<tr>
			...
			<th><spring:message code="discussionmotion.putupfor" text="Put Up For"></spring:message></th>
			<th><spring:message code="discussionmotion.sendto" text="Send To"></spring:message></th>			
		</tr>			
