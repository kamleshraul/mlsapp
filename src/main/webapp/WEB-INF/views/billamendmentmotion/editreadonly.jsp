	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$.get('ref/billamendmentmotion/amendedBillInfo?amendedBillInfo='+$('#amendedBillInfo').val(), function(data) {
				$('#readonly_showAmendedBillText').empty();
				$('#readonly_showAmendedBillText').html(data);				
				$('#readonly_showAmendedBill').text($('#readonly_showAmendedBillText').html());
			}).fail(function() {
				if($("#ErrorMsg").val()!=''){
			...
			$('#readonly_showAmendedBill').click(function() {
...
<body>
	...
	<div id="billDiv">
		...
		<p>	
			...
			<a id="readonly_showAmendedBill" href="#"></a>
			<span id="readonly_showAmendedBillText" style="display:none;"></span>
		</p>
