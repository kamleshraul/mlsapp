 ...
 * File: org.mkcl.els.common.vo.MemberPartyWiseReportVO.java
...
/**
 * The Class MemberPartyWiseReportVO.
 *
 * @author amitd
 * @author sandeeps
 * @since v1.0.0
 */
public class MemberPartyWiseReportVO {
    ...
    private List<MemberPartyWiseVO> memberPartyWiseVOs;
    ...
    /**
     * Gets the member party wise v os.
     *
     * @return the member party wise v os
     */
    public List<MemberPartyWiseVO> getMemberPartyWiseVOs() {
		return memberPartyWiseVOs;
	}

	/**
	 * Sets the member party wise v os.
	 *
	 * @param memberPartyWiseVOs the new member party wise v os
	 */
	public void setMemberPartyWiseVOs(final List<MemberPartyWiseVO> memberPartyWiseVOs) {
		this.memberPartyWiseVOs = memberPartyWiseVOs;
	}
}
