 ...
 * File: org.mkcl.els.common.vo.MemberQualificationWiseReportVO.java
...
/**
 * The Class MemberQualificationWiseReportVO.
 *
 * @author amitd
 * @author sandeeps
 * @since v1.0.0
 */
public class MemberQualificationWiseReportVO {
    ...
    /** The member qualification wise v os. */
    private List<MemberQualificationWiseVO> memberQualificationWiseVOs;
    ...
    /**
     * Gets the member qualification wise v os.
     *
     * @return the member qualification wise v os
     */
    public List<MemberQualificationWiseVO> getMemberQualificationWiseVOs() {
        return memberQualificationWiseVOs;
    }


    /**
     * Sets the member qualification wise v os.
     *
     * @param memberQualificationWiseVOs the new member qualification wise v os
     */
    public void setMemberQualificationWiseVOs(
            final List<MemberQualificationWiseVO> memberQualificationWiseVOs) {
        this.memberQualificationWiseVOs = memberQualificationWiseVOs;
    }
