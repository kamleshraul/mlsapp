...
public class UserGroup extends BaseDomain implements Serializable {
	...
	public static Reference findGovernorSpeechNoticeActor(final GovernorSpeechNotice notice,final String userGroupType,final String level,final String locale) throws ELSException {
		return getUserGroupRepository().findGovernorSpeechNoticeActor(notice, userGroupType, level, locale);
	}
	...
	public static Reference findAppropriationBillMotionActor(final AppropriationBillMotion motion,final String userGroupType,final String level,final String locale) throws ELSException {
		return getUserGroupRepository().findAppropriationBillMotionActor(motion, userGroupType, level, locale);
	}
	...
	public static List<UserGroup> findAllActive(Credential credential,
			UserGroupType usergroupType, Date onDate, String locale) {
		return getUserGroupRepository().findAllActive(credential, usergroupType, onDate, locale);
	}
