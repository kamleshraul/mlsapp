...
public class BaseDomain {
    ...
    public static <T extends BaseDomain, U> T findById(final Class persistenceClass,
                                                       final Long id) {
    ...
    public static <T extends BaseDomain> T findByName(final Class persistenceClass,
                                                      ...
                                                      final String locale) {
        return (T) getBaseRepository().findByName(
                persistenceClass, fieldValue, locale);
    }
    ...
    @SuppressWarnings("unchecked")
    @Transactional(readOnly = true)
    public static <T extends BaseDomain> T findByFieldName(final Class persistenceClass,
                                                           final String fieldName,
                                                           final String fieldValue,
                                                           final String locale) {
        return (T) getBaseRepository().findByFieldName(
                persistenceClass, fieldName, fieldValue, locale);
    }
    ...
    @SuppressWarnings("unchecked")
    @Transactional(readOnly = true)
    public static <T extends BaseDomain> T findByFieldNames(final Class persistenceClass,
                                                            final Map<String, String> names,
                                                            final String locale) {
        return (T) getBaseRepository().findByFieldNames(
                persistenceClass, names, locale);
    }
    ...
    @SuppressWarnings("unchecked")
    @Transactional(readOnly = true)
    public static <T extends BaseDomain> List<T> findAll(final Class persistenceClass,
                                                         final String sortBy,
                                                         final String sortOrder,
                                                         final String locale) {
        return getBaseRepository().findAll(
                persistenceClass, sortBy, sortOrder, locale);
    }
