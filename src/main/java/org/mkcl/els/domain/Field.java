...
public class Field extends BaseDomain implements Serializable {
     ...
     */
    public Field(final String name, final String detail,
            final String mandatory, final String visible,
            final Integer position, final String hint, final String form,
            final Long version, final String locale) {
        super();
        this.name = name;
        this.detail = detail;
