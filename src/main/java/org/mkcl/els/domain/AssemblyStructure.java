...
public class AssemblyStructure extends BaseDomain implements Serializable {
    ...
    // @Autowired
    // private transient AssemblyStructureRepository
    // assemblyStructureRepository;
    //
    // ==========Constructors==========
    /**
    ...
    // */
    // public static AssemblyStructureRepository
    // getAssemblyStructureRepository() {
    ...
    // */
    // @Transactional(readOnly = true)
    // public static List<AssemblyStructure> findAllSorted(final String
    // property,
    // final String locale,
    // final boolean descOrder) {
    // List<AssemblyStructure> list =
    // getAssemblyStructureRepository().findAllSorted(
