 ...
 */
@Controller
@RequestMapping("/masters_assemblystructs")
public class AssemblyStructureController extends
        GenericController<AssemblyStructure> {
    // /**
    // * List.
    // *
    ...
    // @Valid @ModelAttribute("assemblyStructure") final AssemblyStructure
    // assemblyStructure,
