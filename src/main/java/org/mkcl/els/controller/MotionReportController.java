...
//								
//				List<Object> objects = MotionReportHelper.getSesionAndDeviceType(request, locale.toString());
//				
...
//						}
//					}
//					Object[] reportData = MotionReportHelper.prepareUnstarredYaadiData(session, totalQuestionsInYaadi, locale.toString());
//					/**** generate report ****/
//					if(!isError) {
...
//									if(houseType.equals(ApplicationConstants.LOWER_HOUSE)) {
//										clubbedMemberNames.append(MotionReportHelper.findMemberNamesForAddedQuestion(clubbedQuestion, previousQuestionsMemberNames.toString(), memberNameFormat, true));
//									} else if(houseType.equals(ApplicationConstants.UPPER_HOUSE)) {
//										clubbedMemberNames.append(MotionReportHelper.findMemberNamesForAddedQuestion(clubbedQuestion, previousQuestionsMemberNames.toString(), memberNameFormat, false));
//									}		
