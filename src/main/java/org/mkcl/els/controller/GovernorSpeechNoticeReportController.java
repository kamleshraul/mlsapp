...
@Controller
@RequestMapping("governorspeechnotice/report")
public class GovernorSpeechNoticeReportController extends BaseController {
	...
	public String getReport(HttpServletRequest request, Model model, Locale locale){
		...
		return "governorspeechnotice/reports/"+request.getParameter("reportout");		
	}
