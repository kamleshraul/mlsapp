 ...
 * File: org.mkcl.els.controller.ReligionController.java
 ...
 */
@Controller
@RequestMapping("/masters_religions")
public class ReligionController extends GenericController<Religion>{
	 ...
	 */
	protected void customValidateCreate(final Religion domain,
	 ...
	 */
	protected void customValidateUpdate(final Religion domain,
			final BindingResult result, final HttpServletRequest request) {
		customValidate(domain, result, request);
	}
	 ...
	 */
	private void customValidate(final Religion domain,
			final BindingResult result, final HttpServletRequest request) {
		Map<String, String> names = new HashMap<String, String>();
		names.put("religion", domain.getReligion());
		...
		if (duplicateParameter) {
			result.rejectValue("religion", "NonUnique", params,
					"Duplicate Parameter");
		}
