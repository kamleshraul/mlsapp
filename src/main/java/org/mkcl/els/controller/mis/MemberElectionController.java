...
public class MemberElectionController extends GenericController<ElectionResult>{
	...
	private void populate(final ModelMap model, final ElectionResult domain,
        ...
        model.addAttribute("parties",Party.findAll(Party.class,"name",ApplicationConstants.ASC, locale));
        ...
        model.addAttribute("constituencies",Constituency.findByDefaultStateAndHouseType(defaultState,houseType, locale,"name",ApplicationConstants.ASC));
