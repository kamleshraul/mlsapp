 ...
 */
@Controller
@RequestMapping("/masters_assemblyroles")
public class AssemblyRoleController extends GenericController<AssemblyRole> {
}
/**
 * List.
 *
...
// public String create(@Valid @ModelAttribute("assemblyRole") final
...
// public String update(@Valid @ModelAttribute("assemblyRole") final
// AssemblyRole assemblyRole,
// final BindingResult result,
// final ModelMap model) {
// this.validate(assemblyRole, result);
