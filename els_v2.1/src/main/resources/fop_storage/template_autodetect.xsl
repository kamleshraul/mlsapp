...
<xsl:stylesheet version="1.1"
    ...
    <xsl:variable name="language" select="RotationOrderData/locale"/>
    <xsl:variable name="formatOut" select="RotationOrderData/outputFormat"/>
  ...
  =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-->
    ...
    <xsl:template match="RotationOrderData">
	    ...
	    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	        <fo:layout-master-set>
	            ...
	            <fo:simple-page-master master-name="simple"
	                            page-height="29cm" page-width="21cm" margin-left="1cm"
	                            margin-right="1cm">
		    ...
		    <!-- <fo:static-content flow-name="ra-right">
			  <fo:block font-size="10pt">
				...
				<fo:table-row>
				  <fo:table-cell>
				    <fo:block text-align="start" font-family="{$font}" font-style="italic" font-weight="bold">
				      powered by महाराष्ट्र ज्ञान महामंडळ मर्यादित
				    </fo:block>
				  </fo:table-cell>
				  <fo:table-cell>
				    <fo:block text-align="end" font-family="{$font}" font-style="italic" font-weight="normal">Page 
				      <fo:page-number/> of 
		    ...
		    <fo:static-content flow-name="ra-left">
			  <fo:block font-size="10pt">
				...
				<fo:table-row>
				  <fo:table-cell>
				    <fo:block text-align="start" font-family="{$font}" font-style="italic" font-weight="normal">Page 
				      <fo:page-number/> 
				  ...
				  <fo:table-cell>
				    <fo:block text-align="end" font-family="{$font}" font-style="italic" font-weight="bold">
				      powered by महाराष्ट्र ज्ञान महामंडळ मर्यादित
				    </fo:block>
				  </fo:table-cell>
				</fo:table-row>
			...
			<fo:block text-align='center' >
			    <fo:external-graphic src="../../../src/main/webapp/resources/images/vidhanmandal.JPG"  content-height="4cm"  content-width="3cm" />
			</fo:block>

	            	<fo:block font-family="{$font}" font-size="13px" break-after="page">						
						<xsl:apply-templates select="rotationOrderMainCover"></xsl:apply-templates>
						<!-- <xsl:value-of select="rotationOrderCover" disable-output-escaping="yes"/> -->															
					</fo:block>				
					
					<fo:block font-family="{$font}" font-size="13px">						
						<xsl:apply-templates select="rotationOrderMainHeader"></xsl:apply-templates>
						<!-- <xsl:value-of select="rotationOrderCover" disable-output-escaping="yes"/> -->															
					</fo:block>
							   ...
							   <fo:table-row border="solid 0.1mm black">
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center" font-weight="bold">
		                                                                    गट <fo:block/>क्र.<fo:block/>(१)
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center" font-weight="bold">
		                                                                    गटामध्ये समाविष्ट असलेले मंत्री<fo:block/><fo:block/><fo:block/>(२)
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center" font-weight="bold">
		                                                                    प्रश्नांच्या उत्तराचा दिनांक<fo:block/><fo:block/><fo:block/>(३)
			                                    </fo:block>
				                        	</fo:table-cell>
				                        	<fo:table-cell border-width="0.5pt" border-style="solid">
				                        	    <fo:block text-align="center" font-weight="bold">
		                                                                    प्रश्न सूचना मिळण्याचा अखेरचा दिनांक<fo:block/><fo:block/>(४)
			                                    </fo:block>
				                        	</fo:table-cell>
				            	</fo:table-row>				
							</fo:table-header>
	                        <fo:table-body>	                        	
	                            <xsl:for-each select="./rotationOrderForGroupList/rotationOrderForGroup" >
	                                <fo:table-row border="solid 0.1mm black">
					
	                                	
	                                    <fo:table-cell display-align="center" text-align="left" border-width="0.5pt" border-style="solid">
	                                        <fo:block  text-align="center">
	                                    ...
	                                    <fo:table-cell padding-left="5" display-align="center" text-align="left" border-width="0.5pt" border-style="solid">
                                            <fo:block>
                                            	<!-- <xsl:for-each select="./numberOfMinisteries + ./ministries" >
	                                    ...
	                                    <fo:table-cell padding-left="5" display-align="center" text-align="left" border-width="0.5pt" border-style="solid">
	                                        <fo:block>
	                                        	<fo:block/>	
		                                        <xsl:for-each select="./finalSubmissionDates" >
		                                        	<xsl:apply-templates></xsl:apply-templates>
							  						<xsl:if test="position() != last()"><fo:block/></xsl:if>
							  					</xsl:for-each>
						  					</fo:block>
